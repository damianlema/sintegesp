...
<tr>
    ...
    <?
	/*//echo "PRUEBA: ".$_SESSION["rutaReportes"];
		if($_SESSION["rutaReportes"] == "gobernacion"){
			$url="../../imagenes/logo_gob.jpg";
			$dimensiones = "15%";
		}else if($_SESSION["rutaReportes"] == "salud"){
			$url="../../imagenes/logo_salud.jpg";
			$dimensiones = "40%";
		}else if($_SESSION["rutaReportes"] == "alcaldia"){
			$url="../../imagenes/logo_alcaldia.jpg";
			$dimensiones = "15%";
		}else if($_SESSION["rutaReportes"] == "manual"){
			$url="../../imagenes/logo_institucion.jpg";
			$dimensiones = "15%";
		}*/
...
<tr>
	<td rowspan="2"> <div style="height:426px" class="div"></div></td>
	<td>
