...
function preori($pdf, $anio_fiscal, $fuente_financiamiento, $tipo_presupuesto) {
	...
	if ($fuente_financiamiento != "") {
		$pdf->SetFont('Arial', '', 8); $pdf->Cell(35, 4, 'Fuente de Financiamiento: ', 0, 0, 'L');
...
function preres($pdf, $anio_fiscal, $fuente_financiamiento, $tipo_presupuesto, $campos) {
	...
	if ($campos[10]) $pdf->Cell(23, 4, 'Reservado Dis.', 0, 0, 'R', 1);
...
function detalle_por_partida($pdf, $idcategoria, $idpartida, $anio_fiscal, $financiamiento, $tipo_presupuesto, $nom_fuente_financiamiento, $nom_tipo_presupuesto, $idordinal, $campos) {
	...
	$pdf->SetFont('Arial', '', 8); $pdf->Cell(35, 5, utf8_decode('Categoría Programática: '), 0, 0, 'L');
	$pdf->SetFont('Arial', 'B', 8); $pdf->Cell(160, 5, $field['codigo'].' '.$field['denounidad'], 0, 1, 'L');
	$pdf->SetFont('Arial', '', 8); $pdf->Cell(35, 5, 'Partida: ', 0, 0, 'L');
	$pdf->SetFont('Arial', 'B', 8); $pdf->Cell(160, 5, utf8_decode($partida), 0, 1, 'L');
	$pdf->SetFont('Arial', '', 8); $pdf->Cell(35, 5, 'Monto Original: ', 0, 0, 'L');
	$pdf->SetFont('Arial', 'B', 8); $pdf->Cell(30, 5, $monto_original, 0, 1, 'R');
	$pdf->SetFont('Arial', '', 8); $pdf->Cell(35, 5, 'Total Aumentos: ', 0, 0, 'L');
	$pdf->SetFont('Arial', 'B', 8); $pdf->Cell(30, 5, $total_aumento, 0, 1, 'R');
	$pdf->SetFont('Arial', '', 8); $pdf->Cell(35, 5, 'Total Solicitud Aumentos: ', 0, 0, 'L');
	$pdf->SetFont('Arial', 'B', 8); $pdf->Cell(30, 5, '('.$total_solicitud_aumento.')', 0, 1, 'R');
	$pdf->SetFont('Arial', '', 8); $pdf->Cell(35, 5, 'Total Disminuciones: ', 0, 0, 'L');
	$pdf->SetFont('Arial', 'B', 8); $pdf->Cell(30, 5, $total_disminucion, 0, 1, 'R');
	$pdf->SetFont('Arial', '', 8); $pdf->Cell(35, 5, 'Total Reservado Para Disminuir: ', 0, 0, 'L');
	...
	$pdf->SetFont('Arial', '', 8); $pdf->Cell(35, 5, 'Disponible Para Compromisos = Monto Actual - Total Pre Compromisos - Total Compromisos - Reservado Para Disminuir', 0, 0, 'R');
	$pdf->Ln(4);
	//----------------------------------------------------
	$pdf->SetDrawColor(255, 255, 255); $pdf->SetFillColor(100, 100, 100); $pdf->SetTextColor(255, 255, 255);
	$pdf->SetFont('Arial', 'B', 5);
...
function ejecucion_detallada($pdf, $anio_fiscal, $fuente_financiamiento, $tipo_presupuesto, $campos) {
	...
	/////////////////////////////
	$pdf->SetFont('Arial', '', 8); $pdf->Cell(35, 4, 'Fuente de Financiamiento: ', 0, 0, 'L'); $pdf->SetFont('Arial', 'B', 8); $pdf->Cell(50, 4, $fuente_financiamiento, 0, 1, 'L');
	$pdf->SetFont('Arial', '', 8); $pdf->Cell(35, 4, 'Tipo de Presupuesto: ', 0, 0, 'L'); $pdf->SetFont('Arial', 'B', 8); $pdf->Cell(50, 4, $tipo_presupuesto, 0, 1, 'L');
	$pdf->SetFont('Arial', '', 8); $pdf->Cell(35, 4, utf8_decode('Año Fiscal: '), 0, 0, 'L'); $pdf->SetFont('Arial', 'B', 8); $pdf->Cell(50, 4, $anio_fiscal, 0, 1, 'L');
	//----------------------------------------------------
	$pdf->SetDrawColor(255, 255, 255); $pdf->SetFillColor(100, 100, 100); $pdf->SetTextColor(255, 255, 255);
	$pdf->SetFont('Arial', 'B', 5);
	$pdf->Cell(15, 4, 'Documento', 0, 0, 'C', 1);
...
function resumen_por_partida($pdf, $anio_fiscal, $fuente_financiamiento, $tipo_presupuesto, $partida, $campos) {
	...
	$pdf->SetFont('Arial', '', 8); $pdf->Cell(35, 4, 'Tipo de Presupuesto: ', 0, 0, 'L'); $pdf->SetFont('Arial', 'B', 8); $pdf->Cell(50, 4, $tipo_presupuesto, 0, 1, 'L');
	$pdf->SetFont('Arial', '', 8); $pdf->Cell(35, 4, utf8_decode('Año Fiscal: '), 0, 0, 'L'); $pdf->SetFont('Arial', 'B', 8); $pdf->Cell(50, 4, $anio_fiscal, 0, 1, 'L');
	$pdf->SetFont('Arial', '', 8); $pdf->Cell(35, 4, utf8_decode('Clasificador: '), 0, 0, 'L'); $pdf->SetFont('Arial', 'B', 8); $pdf->Cell(50, 4, utf8_decode($partida), 0, 1, 'L');
	//----------------------------------------------------
	$pdf->SetDrawColor(255, 255, 255); $pdf->SetFillColor(100, 100, 100); $pdf->SetTextColor(255, 255, 255);
	$pdf->SetFont('Arial', 'B', 5);
...
function ejecucion_trimestral($pdf, $anio_fiscal, $fuente_financiamiento, $tipo_presupuesto) {
	...
	/////////////////////////////
	$pdf->SetFont('Arial', '', 6); $pdf->Cell(35, 4, 'Fuente de Financiamiento: ', 0, 0, 'L'); $pdf->SetFont('Arial', 'B', 6); $pdf->Cell(50, 4, $fuente_financiamiento, 0, 1, 'L');
...
function traslado_presupuestario($pdf, $nsolicitud, $fsolicitud, $pag, $tipo_partida, $estado) {
	...
	elseif ($estado=="procesado") $titulo="Traslados Presupuestarios";
	elseif ($estado=="anulado") $titulo="Traslados Presupuestarios (Anulado)";
	$pdf->Ln(5);
	$pdf->SetFont('Arial', 'B', 16);
	$pdf->Cell(205, 8, utf8_decode($titulo), 0, 1, 'C');
	/////////////////////////////
	$pdf->SetXY(5, 35);
	$pdf->SetFont('Arial', '', 9); $pdf->Cell(25, 7, 'Nro. Solicitud: ', 0, 0, 'L'); $pdf->SetFont('Arial', 'B', 9); $pdf->Cell(50, 7, $nsolicitud, 0, 0, 'L');
	$pdf->SetFont('Arial', '', 9); $pdf->Cell(28, 7, 'Fecha Solicitud: ', 0, 0, 'L'); $pdf->SetFont('Arial', 'B', 9); $pdf->Cell(102, 7, $fsolicitud, 0, 0, 'L');
	/////////////////////////////
	$pdf->SetXY(5, 108);
	$pdf->SetFont('Arial', 'B', 10); $pdf->Cell(205, 5, $tipo_partida, 0, 1, 'C');
...
function anexo_traslado_presupuestario($pdf, $nsolicitud, $fsolicitud, $pag, $tipo_partida, $estado) {
	...
	$pdf->SetXY(5, 35);
	$pdf->SetFont('Arial', 'B', 9);
	$pdf->Cell(75, 7, 'Nro. Solicitud: '.$nsolicitud, 0, 0, 'L'); $pdf->Cell(130, 7, 'Fecha Solicitud: '.$fsolicitud, 0, 0, 'L');
	/////////////////////////////
	$pdf->SetXY(5, 50);
	$pdf->SetFont('Arial', 'B', 10); $pdf->Cell(205, 5, $tipo_partida, 0, 1, 'C');
	$pdf->SetDrawColor(0, 0, 0); $pdf->SetFillColor(255, 255, 255); $pdf->SetTextColor(0, 0, 0);
...
function disminucion_presupuestaria($pdf, $nsolicitud, $fsolicitud, $pag, $tipo_partida, $y, $estado) {
	...
	elseif ($estado=="procesado") $titulo="Disminucion Presupuestaria";
	elseif ($estado=="anulado") $titulo="Disminucion Presupuestaria (Anulado)";
	$pdf->Ln(5);
	$pdf->SetFont('Arial', 'B', 16);
	$pdf->Cell(205, 8, utf8_decode($titulo), 0, 1, 'C');
	/////////////////////////////
...
function credito_adicional($pdf, $nsolicitud, $fsolicitud, $pag, $tipo_partida, $y, $estado) {
	...
	elseif ($estado=="procesado") $titulo="Créditos Adicionales";
	elseif ($estado=="anulado") $titulo="Créditos Adicionales (Anulado)";
	$pdf->Ln(5);
	$pdf->SetFont('Arial', 'B', 16);
	$pdf->Cell(205, 8, utf8_decode($titulo), 0, 1, 'C');
	/////////////////////////////
...
function rectificacion_partida($pdf, $nsolicitud, $fsolicitud, $pag, $tipo_partida, $estado) {
	...
	elseif ($estado=="procesado") $titulo="Rectificación Presupuestaria";
	elseif ($estado=="anulado") $titulo="Rectificación Presupuestaria (Anulado)";
	$pdf->Ln(5);
	$pdf->SetFont('Arial', 'B', 16);
	$pdf->Cell(205, 8, utf8_decode($titulo), 0, 1, 'C');
	/////////////////////////////
...
function conlidado_por_categoria($pdf, $anio_fiscal, $fuente_financiamiento, $tipo_presupuesto, $campos, $periodo) {
	...
	$pdf->SetFont('Arial', '', 8); $pdf->Cell(35, 4, 'Tipo de Presupuesto: ', 0, 0, 'L'); $pdf->SetFont('Arial', 'B', 8); $pdf->Cell(50, 4, $tipo_presupuesto, 0, 1, 'L');
	$pdf->SetFont('Arial', '', 8); $pdf->Cell(35, 4, utf8_decode('Año Fiscal: '), 0, 0, 'L'); $pdf->SetFont('Arial', 'B', 8); $pdf->Cell(50, 4, $anio_fiscal, 0, 1, 'L');
	$pdf->SetFont('Arial', '', 8); $pdf->Cell(35, 4, utf8_decode('Periodo: '), 0, 0, 'L'); $pdf->SetFont('Arial', 'B', 8); $pdf->Cell(50, 4, $periodo, 0, 1, 'L');
	//	--------------------
	$pdf->SetDrawColor(255, 255, 255); $pdf->SetFillColor(100, 100, 100); $pdf->SetTextColor(255, 255, 255);
	$pdf->SetFont('Arial', 'B', 5);
	$pdf->Cell(20, 4, 'Partida', 0, 0, 'C', 1);
...
function rendicion_mensual($pdf, $anio_fiscal, $fuente_financiamiento, $tipo_presupuesto, $periodo) {
	...
	$pdf->SetFont('Arial', '', 8); $pdf->Cell(35, 4, 'Tipo de Presupuesto: ', 0, 0, 'L'); $pdf->SetFont('Arial', 'B', 8); $pdf->Cell(50, 4, $tipo_presupuesto, 0, 1, 'L');
	$pdf->SetFont('Arial', '', 8); $pdf->Cell(35, 4, utf8_decode('Año Fiscal: '), 0, 0, 'L'); $pdf->SetFont('Arial', 'B', 8); $pdf->Cell(50, 4, $anio_fiscal, 0, 1, 'L');
	$pdf->SetFont('Arial', '', 8); $pdf->Cell(35, 4, utf8_decode('Mes: '), 0, 0, 'L'); $pdf->SetFont('Arial', 'B', 8); $pdf->Cell(50, 4, $periodo, 0, 1, 'L');
	//	--------------------
	$pdf->SetDrawColor(255, 255, 255); $pdf->SetFillColor(100, 100, 100); $pdf->SetTextColor(255, 255, 255);
	$pdf->SetFont('Arial', 'B', 5);
	$pdf->Cell(20, 4, 'Partida', 0, 0, 'C', 1);
