...
switch ($nombre) {
    ...
    case "preres":
        ...
        while ($field = mysql_fetch_array($query)) {
            ...
            if ($field["Tipo"] == "partida") {
                if (($chksobregiradas && $resta_disponible < 0) || !$chksobregiradas) {
                    ...
                    $y  = $pdf->GetY();
                    $x  = 5;
                    $nb = $pdf->NbLines(27, utf8_decode($field["NomPartida"]));
                    $hf = 3 * $nb;
                    $pdf->SetXY($x, $y);
                    $pdf->Cell(20, $hf, $clasificador, 0, 1, 'C', 1);
                    $x += 20;
                    $pdf->SetXY($x, $y);
                    $pdf->MultiCell(27, 3, utf8_decode($field["NomPartida"]), 0, 'L', 1);
                    $x += 27;
                    if ($campos[0]) {
                        $pdf->SetXY($x, $y);
                        $pdf->Cell(23, $hf, $formulado, 0, 1, 'R', 1);
                        $x += 23;}
                    if ($campos[1]) {
                        $pdf->SetXY($x, $y);
                        $pdf->Cell(23, $hf, $aumento, 0, 1, 'R', 1);
                        $x += 23;}
                    if ($campos[2]) {
                        $pdf->SetXY($x, $y);
                        $pdf->Cell(23, $hf, $disminucion, 0, 1, 'R', 1);
                        $x += 23;}
                    if ($campos[3]) {
                        $pdf->SetXY($x, $y);
                        $pdf->Cell(23, $hf, $modificado, 0, 1, 'R', 1);
                        $x += 23;}
                    if ($campos[4]) {
                        $pdf->SetXY($x, $y);
                        $pdf->Cell(23, $hf, $actual, 0, 1, 'R', 1);
                        $x += 23;}
                    if ($campos[10]) {
                        $pdf->SetXY($x, $y);
                        $pdf->Cell(23, $hf, $reservado, 0, 1, 'R', 1);
                        $x += 23;}
                    if ($campos[5]) {
                        $pdf->SetXY($x, $y);
                        $pdf->Cell(23, $hf, $precompromiso, 0, 1, 'R', 1);
                        $x += 23;}
                    if ($campos[6]) {
                        $pdf->SetXY($x, $y);
                        $pdf->Cell(23, $hf, $compromiso, 0, 1, 'R', 1);
                        $x += 23;
                        $pdf->SetXY($x, $y);
                        $pdf->Cell(11, $hf, $pcompromiso . ' %', 0, 1, 'R', 1);
                        $x += 11;
                    }
                    if ($campos[7]) {
                        $pdf->SetXY($x, $y);
                        $pdf->Cell(23, $hf, $causado, 0, 1, 'R', 1);
                        $x += 23;
                        $pdf->SetXY($x, $y);
                        $pdf->Cell(11, $hf, $pcausado . ' %', 0, 1, 'R', 1);
                        $x += 11;
                    }
                    if ($campos[8]) {
                        $pdf->SetXY($x, $y);
                        $pdf->Cell(23, $hf, $pagado, 0, 1, 'R', 1);
                        $x += 23;
                        $pdf->SetXY($x, $y);
                        $pdf->Cell(11, $hf, $ppagado . ' %', 0, 1, 'R', 1);
                        $x += 11;
                    }
                    if ($campos[9]) {
                        $pdf->SetXY($x, $y);
                        $pdf->Cell(23, $hf, $disponible, 0, 1, 'R', 1);
                        $x += 23;
                        $pdf->SetXY($x, $y);
                        $pdf->Cell(11, $hf, $pdisponible . ' %', 0, 1, 'R', 1);
                        $x += 11;
                    }
                    $pdf->Ln(2);
                }
                ...
                if (($chksobregiradas && $resta_disponible < 0) || !$chksobregiradas) {
                    ...
                    if ($field['codordinal'] == "0000") {
                        ...
                        $y  = $pdf->GetY();
                        $x  = 5;
                        $nb = $pdf->NbLines(27, utf8_decode($field['codordinal'] . ' ' . $field["nomordinal"]));
                        $hf = 3 * $nb;
                        $pdf->SetXY($x, $y);
                        $pdf->Cell(20, $hf, $clasificador, 0, 1, 'C', 1);
                        $x += 20;
                        $pdf->SetXY($x, $y);
                        $pdf->MultiCell(27, 3, utf8_decode($field['codordinal'] . ' ' . $field["nomordinal"]), 0, 'L', 1);
                        $x += 27;
                        if ($campos[0]) {
                            $pdf->SetXY($x, $y);
                            $pdf->Cell(23, $hf, $formulado, 0, 1, 'R', 1);
        ...
        if ($campos[0]) {
            $pdf->SetXY($x, $y);
            $pdf->Cell(23, $hf, $sum_formulado, 0, 1, 'R', 1);
            $x += 23;}
        if ($campos[1]) {
            $pdf->SetXY($x, $y);
            $pdf->Cell(23, $hf, $sum_aumento, 0, 1, 'R', 1);
            $x += 23;}
        if ($campos[2]) {
            $pdf->SetXY($x, $y);
            $pdf->Cell(23, $hf, $sum_disminucion, 0, 1, 'R', 1);
            $x += 23;}
        if ($campos[3]) {
            $pdf->SetXY($x, $y);
            $pdf->Cell(23, $hf, $sum_modificado, 0, 1, 'R', 1);
            $x += 23;}
        if ($campos[4]) {
            $pdf->SetXY($x, $y);
            $pdf->Cell(23, $hf, $sum_actual, 0, 1, 'R', 1);
            $x += 23;}
        if ($campos[10]) {
            $pdf->SetXY($x, $y);
            $pdf->Cell(23, $hf, $sum_reservado, 0, 1, 'R', 1);
            $x += 23;}
        if ($campos[5]) {
            $pdf->SetXY($x, $y);
            $pdf->Cell(23, $hf, $sum_precompromiso, 0, 1, 'R', 1);
            $x += 23;}
        if ($campos[6]) {
            $pdf->SetXY($x, $y);
            $pdf->Cell(23, $hf, $sum_compromiso, 0, 1, 'R', 1);
            $x += 23;
            $pdf->SetXY($x, $y);
            $pdf->Cell(11, $hf, $tpcompromiso . ' %', 0, 1, 'R', 1);
            $x += 11;
        }
        if ($campos[7]) {
            $pdf->SetXY($x, $y);
            $pdf->Cell(23, $hf, $sum_causado, 0, 1, 'R', 1);
            $x += 23;
            $pdf->SetXY($x, $y);
            $pdf->Cell(11, $hf, $tpcausado . ' %', 0, 1, 'R', 1);
            $x += 11;
        }
        if ($campos[8]) {
            $pdf->SetXY($x, $y);
            $pdf->Cell(23, $hf, $sum_pagado, 0, 1, 'R', 1);
            $x += 23;
            $pdf->SetXY($x, $y);
            $pdf->Cell(11, $hf, $tppagado . ' %', 0, 1, 'R', 1);
            $x += 11;
        }
        if ($campos[9]) {
            $pdf->SetXY($x, $y);
            $pdf->Cell(23, $hf, $sum_disponible, 0, 1, 'R', 1);
            $x += 23;
            $pdf->SetXY($x, $y);
            $pdf->Cell(11, $hf, $tpdisponible . ' %', 0, 1, 'R', 1);
            $x += 11;
        }
        break;
    ...
    case "consolidado":
        ...
        if ($dia_anterior == 0) {
            $mes_anterior = $m - 1;
            $dia_anterior = $mes[$mes_anterior];if ($mes_anterior < 10) {
                $mes_anterior = "0" . $mes_anterior;
            }
            if ($dia_anterior < 10) {
                $dia_anterior = "0" . $dia_anterior;
            }
            if ($mes_anterior == 0 || $dia_anterior == 0) {
                $hasta_anterior = "$anio_fiscal-01-01";
            } else {
                $hasta_anterior = $a . "-" . $mes_anterior . "-" . $dia_anterior;
            }
        } else {
            if ($m < 10) {
                $m = "0" . $m;
            ...
            if ($m == 0 || $dia_anterior == 0) {
                $hasta_anterior = "$anio_fiscal-01-01";
            } else {
                $hasta_anterior = $a . "-" . $m . "-" . $dia_anterior;
            }
        }
        //---------------------------------------------
        ...
        for ($i = 0; $i < $rows; $i++) {
            ...
            if ($_COMPROMISO_ANTERIOR[$par] != 0 && $actual_anterior != 0) {
                $pcompromiso_anterior = $_COMPROMISO_ANTERIOR[$par] * 100 / $actual_anterior;
            } else {
                $pcompromiso_anterior = 0;
            }

            if ($_CAUSADO_ANTERIOR[$par] != 0 && $actual_anterior != 0) {
                $pcausado_anterior = $_CAUSADO_ANTERIOR[$par] * 100 / $actual_anterior;
            } else {
                $pcausado_anterior = 0;
            }

            if ($_PAGADO_ANTERIOR[$par] != 0 && $actual_anterior != 0) {
                $ppagado_anterior = $_PAGADO_ANTERIOR[$par] * 100 / $actual_anterior;
            } else {
                $ppagado_anterior = 0;
            }

            if ($disponible_anterior != 0 && $actual_anterior != 0) {
                $pdisponible_anterior = $disponible_anterior * 100 / $actual_anterior;
            } else {
                $pdisponible_anterior = 0;
            }
            ...
            if (($chksobregiradas && $disponible < 0) || !$chksobregiradas) {
                ...
                $y  = $pdf->GetY();
                $x  = 5;
                $nb = $pdf->NbLines(73, utf8_decode($field["NomPartida"]));
                $hf = 3 * $nb;
                $pdf->SetXY($x, $y);
                $pdf->Cell(20, $hf, $clasificador, 0, 1, 'C', 1);
                $x += 20;
                $pdf->SetXY($x, $y);
                $pdf->MultiCell(323, 3, utf8_decode($field["NomPartida"]), 0, 'L', 1);
                $pdf->Ln(2);
                ...
                $x = 5;
                $pdf->SetXY($x, $y);
                $pdf->Cell(20, $hf, '', 0, 1, 'C', 1);
                $x += 20;
                $pdf->SetXY($x, $y);
                $pdf->MultiCell(50, 3, 'Hasta el: ' . formatoFecha($hasta_anterior), 0, 'R', 1);
                $x += 50;
                if ($campos[0]) {
                    $pdf->SetXY($x, $y);
                    $pdf->Cell(23, $hf, number_format($field['Formulado'], 2, ',', '.'), 0, 1, 'R', 1);
                    $x += 23;}
                if ($campos[1]) {
                    $pdf->SetXY($x, $y);
                    $pdf->Cell(23, $hf, number_format($_AUMENTO_ANTERIOR[$par], 2, ',', '.'), 0, 1, 'R', 1);
                    $x += 23;}
                if ($campos[2]) {
                    $pdf->SetXY($x, $y);
                    $pdf->Cell(23, $hf, number_format($_DISMINUCION_ANTERIOR[$par], 2, ',', '.'), 0, 1, 'R', 1);
                    $x += 23;}
                if ($campos[3]) {
                    $pdf->SetXY($x, $y);
                    $pdf->Cell(23, $hf, number_format($modificacion_anterior, 2, ',', '.'), 0, 1, 'R', 1);
                    $x += 23;}
                if ($campos[4]) {
                    $pdf->SetXY($x, $y);
                    $pdf->Cell(23, $hf, number_format($actual_anterior, 2, ',', '.'), 0, 1, 'R', 1);
                    $x += 23;}
                if ($campos[10]) {
                    $pdf->SetXY($x, $y);
                    $pdf->Cell(23, $hf, number_format($_RESERVADO_ANTERIOR[$par], 2, ',', '.'), 0, 1, 'R', 1);
                    $x += 23;}
                if ($campos[6]) {
                    $pdf->SetXY($x, $y);
                    $pdf->Cell(23, $hf, number_format($_COMPROMISO_ANTERIOR[$par], 2, ',', '.'), 0, 1, 'R', 1);
                    $x += 23;
                    $pdf->SetXY($x, $y);
                    $pdf->Cell(11, $hf, number_format($pcompromiso_anterior, 2, ',', '.') . ' %', 0, 1, 'R', 1);
                    $x += 11;
                }
                if ($campos[7]) {
                    $pdf->SetXY($x, $y);
                    $pdf->Cell(23, $hf, number_format($_CAUSADO_ANTERIOR[$par], 2, ',', '.'), 0, 1, 'R', 1);
                    $x += 23;
                    $pdf->SetXY($x, $y);
                    $pdf->Cell(11, $hf, number_format($pcausado_anterior, 2, ',', '.') . ' %', 0, 1, 'R', 1);
                    $x += 11;
                }
                if ($campos[8]) {
                    $pdf->SetXY($x, $y);
                    $pdf->Cell(23, $hf, number_format($_PAGADO_ANTERIOR[$par], 2, ',', '.'), 0, 1, 'R', 1);
                    $x += 23;
                    $pdf->SetXY($x, $y);
                    $pdf->Cell(11, $hf, number_format($ppagado_anterior, 2, ',', '.') . ' %', 0, 1, 'R', 1);
                    $x += 11;
                }
                if ($campos[9]) {
                    $pdf->SetXY($x, $y);
                    $pdf->Cell(23, $hf, number_format($disponible_anterior, 2, ',', '.'), 0, 1, 'R', 1);
                    $x += 23;
                    $pdf->SetXY($x, $y);
                    $pdf->Cell(11, $hf, number_format($pdisponible_anterior, 2, ',', '.') . ' %', 0, 1, 'R', 1);
                    $x += 11;
                }
                $pdf->Ln(2);
                ...
                $x += 20;
                $pdf->SetXY($x, $y);
                $pdf->MultiCell(50, 3, 'De ' . formatoFecha($fdesde) . ' a ' . formatoFecha($fhasta), 0, 'R', 1);
                $x += 50;
                if ($campos[0]) {
                    $pdf->SetXY($x, $y);
                    $pdf->Cell(23, $hf, '', 0, 1, 'R', 1);
                    $x += 23;}
                if ($campos[1]) {
                    $pdf->SetXY($x, $y);
                    $pdf->Cell(23, $hf, number_format($_AUMENTO[$par], 2, ',', '.'), 0, 1, 'R', 1);
                    $x += 23;}
                if ($campos[2]) {
                    $pdf->SetXY($x, $y);
                    $pdf->Cell(23, $hf, number_format($_DISMINUCION[$par], 2, ',', '.'), 0, 1, 'R', 1);
                    $x += 23;}
                if ($campos[3]) {
                    $pdf->SetXY($x, $y);
                    $pdf->Cell(23, $hf, number_format($modificacion, 2, ',', '.'), 0, 1, 'R', 1);
                    $x += 23;}
                if ($campos[4]) {
                    $pdf->SetXY($x, $y);
                    $pdf->Cell(23, $hf, number_format($actual, 2, ',', '.'), 0, 1, 'R', 1);
                    $x += 23;}
                if ($campos[10]) {
                    $pdf->SetXY($x, $y);
                    $pdf->Cell(23, $hf, number_format($_RESERVADO[$par], 2, ',', '.'), 0, 1, 'R', 1);
                    $x += 23;}
                if ($campos[6]) {
                    $pdf->SetXY($x, $y);
                    $pdf->Cell(23, $hf, number_format($_COMPROMISO[$par], 2, ',', '.'), 0, 1, 'R', 1);
                    $x += 23;
                    $pdf->SetXY($x, $y);
                    $pdf->Cell(11, $hf, number_format($pcompromiso, 2, ',', '.') . ' %', 0, 1, 'R', 1);
                    $x += 11;
                }
                if ($campos[7]) {
                    $pdf->SetXY($x, $y);
                    $pdf->Cell(23, $hf, number_format($_CAUSADO[$par], 2, ',', '.'), 0, 1, 'R', 1);
                    $x += 23;
                    $pdf->SetXY($x, $y);
                    $pdf->Cell(11, $hf, number_format($pcausado, 2, ',', '.') . ' %', 0, 1, 'R', 1);
                    $x += 11;
                }
                if ($campos[8]) {
                    $pdf->SetXY($x, $y);
                    $pdf->Cell(23, $hf, number_format($_PAGADO[$par], 2, ',', '.'), 0, 1, 'R', 1);
                    $x += 23;
                    $pdf->SetXY($x, $y);
                    $pdf->Cell(11, $hf, number_format($ppagado, 2, ',', '.') . ' %', 0, 1, 'R', 1);
                    $x += 11;
                }
                if ($campos[9]) {
                    $pdf->SetXY($x, $y);
                    $pdf->Cell(23, $hf, number_format($disponible, 2, ',', '.'), 0, 1, 'R', 1);
                    $x += 23;
                    $pdf->SetXY($x, $y);
                    $pdf->Cell(11, $hf, number_format($pdisponible, 2, ',', '.') . ' %', 0, 1, 'R', 1);
                    $x += 11;
                }
                $pdf->Ln(2);
                $linea = $pdf->GetY();if ($linea > 175) {
        ...
        if ($campos[0]) {
            $pdf->SetXY($x, $y);
            $pdf->Cell(23, $hf, number_format($sum_formulado, 2, ',', '.'), 0, 1, 'R', 1);
            $x += 23;}
        if ($campos[1]) {
            $pdf->SetXY($x, $y);
            $pdf->Cell(23, $hf, number_format($sum_aumento, 2, ',', '.'), 0, 1, 'R', 1);
            $x += 23;}
        if ($campos[2]) {
            $pdf->SetXY($x, $y);
            $pdf->Cell(23, $hf, number_format($sum_disminucion, 2, ',', '.'), 0, 1, 'R', 1);
            $x += 23;}
        if ($campos[3]) {
            $pdf->SetXY($x, $y);
            $pdf->Cell(23, $hf, number_format($sum_modificacion, 2, ',', '.'), 0, 1, 'R', 1);
            $x += 23;}
        if ($campos[4]) {
            $pdf->SetXY($x, $y);
            $pdf->Cell(23, $hf, number_format($sum_actual, 2, ',', '.'), 0, 1, 'R', 1);
            $x += 23;}
        if ($campos[10]) {
            $pdf->SetXY($x, $y);
            $pdf->Cell(23, $hf, number_format($sum_reservado, 2, ',', '.'), 0, 1, 'R', 1);
            $x += 23;}
        if ($campos[6]) {
            $pdf->SetXY($x, $y);
            $pdf->Cell(23, $hf, number_format($sum_compromiso, 2, ',', '.'), 0, 1, 'R', 1);
            $x += 23;
            $pdf->SetXY($x, $y);
            $pdf->Cell(11, $hf, number_format($tpcompromiso, 2, ',', '.') . ' %', 0, 1, 'R', 1);
            $x += 11;
        }
        if ($campos[7]) {
            $pdf->SetXY($x, $y);
            $pdf->Cell(23, $hf, number_format($sum_causado, 2, ',', '.'), 0, 1, 'R', 1);
            $x += 23;
            $pdf->SetXY($x, $y);
            $pdf->Cell(11, $hf, number_format($tpcausado, 2, ',', '.') . ' %', 0, 1, 'R', 1);
            $x += 11;
        }
        if ($campos[8]) {
            $pdf->SetXY($x, $y);
            $pdf->Cell(23, $hf, number_format($sum_pagado, 2, ',', '.'), 0, 1, 'R', 1);
            $x += 23;
            $pdf->SetXY($x, $y);
            $pdf->Cell(11, $hf, number_format($tppagado, 2, ',', '.') . ' %', 0, 1, 'R', 1);
            $x += 11;

        }
        if ($campos[9]) {
            $pdf->SetXY($x, $y);
            $pdf->Cell(23, $hf, number_format($sum_disponible, 2, ',', '.'), 0, 1, 'R', 1);
            $x += 23;
            $pdf->SetXY($x, $y);
            $pdf->Cell(11, $hf, number_format($tpdisponible, 2, ',', '.') . ' %', 0, 1, 'R', 1);
            $x += 11;
        }
        break;
        ...
        for ($i = 0; $i < $rows; $i++) {
            ...
            if ($field["IdCategoria"] != $IdCategoria) {
                ...
                if ($i != 0) {
                    ...
                    if ($campos[3]) {
                        $pdf->SetXY($x, $y);
                        $pdf->Cell(23, $hf, number_format($sum_modificado, 2, ',', '.'), 0, 1, 'R', 1);
                        $x += 23;}
                    if ($campos[4]) {
                        $pdf->SetXY($x, $y);
                        $pdf->Cell(23, $hf, number_format($sum_actual, 2, ',', '.'), 0, 1, 'R', 1);
            ...
            $y  = $pdf->GetY();
            $x  = 5;
            $nb = $pdf->NbLines(50, utf8_decode($field["NomPartida"]));
            $hf = 3 * $nb;
            $pdf->SetXY($x, $y);
            $pdf->Cell(20, $hf, $clasificador, 0, 1, 'C', 1);
            $x += 20;
            $pdf->SetXY($x, $y);
            $pdf->MultiCell(50, 3, utf8_decode($field["NomPartida"]), 0, 'L', 1);
            $x += 50;
            if ($campos[0]) {
                $pdf->SetXY($x, $y);
                $pdf->Cell(23, $hf, number_format($field['Formulado'], 2, ',', '.'), 0, 1, 'R', 1);
    ...
    case "detalle_por_partida":
            ...
            if ($field["Tipo"] == "partida") {
                ...
                if ($num_rows_rendicion != 0) {
                    while ($field_rendicion = mysql_fetch_array($query_rendicion)) {
                        ...
                        $y  = $pdf->GetY();
                        $x  = 20;
                        $nb = $pdf->NbLines(40, utf8_decode($field_rendicion['concepto']));
                        $hf = 3 * $nb;
                        $pdf->SetXY($x, $y);
                        $pdf->Cell(15, $hf, $field_rendicion['Fecha'], 0, 1, 'C', 1);
                        $x += 15;
                        $pdf->SetXY($x, $y);
                        $pdf->MultiCell(40, 3, utf8_decode($field_rendicion['concepto']), 0, 'L', 1);
                        $x += 40;
                        if ($campos[0]) {
                            $pdf->SetXY($x, $y);
                            $pdf->Cell(23, $hf, '', 0, 1, 'R', 1);
                        ...
                        if ($campos[4]) {
                            $pdf->SetXY($x, $y);
                            $pdf->Cell(23, $hf, number_format($asignacion_ajustada, 2, ',', '.'), 0, 1, 'R', 1);
                            $x += 23;}
                        if ($campos[5]) {
                            $pdf->SetXY($x, $y);
                            $pdf->Cell(23, $hf, '', 0, 1, 'R', 1);
                        ...
                        if ($campos[6]) {
                            $pdf->SetXY($x, $y);
                            $pdf->Cell(23, $hf, $compromisos, 0, 1, 'R', 1);
                            $x += 23;
                            $pdf->SetXY($x, $y);
                            $pdf->Cell(11, $hf, $pcompromiso . ' %', 0, 1, 'R', 1);
                            $x += 11;
                        ...
                        $linea = $pdf->GetY();if ($linea > 190) {
                            detalle_por_partida_tablas($pdf, $campos);
                            $pdf->SetDrawColor(255, 255, 255);
                            $pdf->SetFillColor(255, 255, 255);
                            $pdf->SetTextColor(0, 0, 0);}
                        $h++;
                    ...
                    for ($k = 0; $k < $rows_detalle; $k++) {
                        ...
                        $pdf->SetDrawColor(255, 255, 255);
                        $pdf->SetFillColor(255, 255, 255);
                        if ($detalle['estado'] == "anulado" || $detalle['estado'] == "Anulado") {$pdf->SetTextColor(255, 0, 0);} else {
                            $pdf->SetTextColor(0, 0, 0);
                        }
                        ...
                        if (($detalle['tipo'] == "Requisicion" && ($detalle['ROC'] == "") && $detalle['estado'] == "procesado") || $detalle['tipo'] != "Requisicion") {
                            $y  = $pdf->GetY();
                            $x  = 5;
                            $nb = $pdf->NbLines(40, utf8_decode($detalle['tipo']));
                            $hf = 3 * $nb;
                            $pdf->SetXY($x, $y);
                            $pdf->Cell(15, $hf, $detalle['nro_solicitud'], 0, 1, 'C', 1);
                            $x += 15;
                            $pdf->SetXY($x, $y);
                            $pdf->Cell(15, $hf, $fecha_solicitud, 0, 1, 'C', 1);
                            $x += 15;
                            $pdf->SetXY($x, $y);
                            $pdf->MultiCell(40, 3, utf8_decode($detalle['tipo']), 0, 'L', 1);
                            $x += 40;
                            if ($campos[0]) {
                                $pdf->SetXY($x, $y);
                                $pdf->Cell(23, $hf, '', 0, 1, 'R', 1);
                        ...
                        if ($imprimir_ocs == "SI") {
                            if ($chkjustificacionoc == "1") {
                                ...
                                while ($field_pagados = mysql_fetch_array($query_pagados)) {
                                    ...
                                    $y       = $pdf->GetY();
                                    $x       = 35;
                                    $nb      = $pdf->NbLines(15, utf8_decode($ordenes));
                                    $hf      = 3 * $nb;
                                    $pdf->SetXY($x, $y);
                                    $pdf->MultiCell(50, 3, $ordenes, 0, 'L', 1);
                                    $pdf->Ln(2);
        ...
        if ($num_rows_rendicion != 0) {
            ...
            if ($campos[6]) {
                $pdf->SetXY($x, $y);
                $pdf->Cell(23, $hf, $sum_compromisos, 0, 1, 'R', 1);
                $x += 23;
                $pdf->SetXY($x, $y);
                $pdf->Cell(11, $hf, $tpcompromiso . ' %', 0, 1, 'R', 1);
                $x += 11;
            ...
            if ($campos[0]) {
                $pdf->SetXY($x, $y);
                $pdf->Cell(23, $hf, $sum_original, 0, 1, 'R', 1);
                $x += 23;}
            if ($campos[1]) {
                $pdf->SetXY($x, $y);
                $pdf->Cell(23, $hf, $sum_aumento, 0, 1, 'R', 1);
    ...
    case "ejecucion_detallada":
        ...
        while ($field = mysql_fetch_array($query)) {
            ...
            if ($field["Tipo"] == "partida") {
                ...
                $x += 20;
                $pdf->SetXY($x, $y);
                $pdf->MultiCell(73, 3, utf8_decode($field["NomPartida"]), 0, 'L', 1);
                $x += 73;
                if ($campos[0]) {
                    $pdf->SetXY($x, $y);
                    $pdf->Cell(23, $hf, $monto_original, 0, 1, 'R', 1);
                    $x += 23;}
                if ($campos[1]) {
                    $pdf->SetXY($x, $y);
                    $pdf->Cell(23, $hf, $total_aumento, 0, 1, 'R', 1);
                    $x += 23;}
                if ($campos[2]) {
                    $pdf->SetXY($x, $y);
                    $pdf->Cell(23, $hf, $total_disminucion, 0, 1, 'R', 1);
                    $x += 23;}
                if ($campos[3]) {
                    $pdf->SetXY($x, $y);
                    $pdf->Cell(23, $hf, $modificado, 0, 1, 'R', 1);
                ...
                if ($campos[4]) {
                    $pdf->SetXY($x, $y);
                    $pdf->Cell(23, $hf, $total_actual, 0, 1, 'R', 1);
                    $x += 23;}
                //if ($campos[5]) { $pdf->SetXY($x, $y); $pdf->Cell(23, $hf, $precompromiso, 0, 1, 'R', 1); $x+=23; }
                if ($campos[6]) {
                    $pdf->SetXY($x, $y);
                    $pdf->Cell(23, $hf, $monto_compromiso, 0, 1, 'R', 1);
                    $x += 23;
                    $pdf->SetXY($x, $y);
                    $pdf->Cell(11, $hf, $pcompromiso . ' %', 0, 1, 'R', 1);
                    $x += 11;
                ...
                if ($campos[7]) {
                    $pdf->SetXY($x, $y);
                    $pdf->Cell(23, $hf, $monto_causado, 0, 1, 'R', 1);
                    $x += 23;
                    $pdf->SetXY($x, $y);
                    $pdf->Cell(11, $hf, $pcausado . ' %', 0, 1, 'R', 1);
                    $x += 11;
                ...
                if ($campos[9]) {
                    $pdf->SetXY($x, $y);
                    $pdf->Cell(23, $hf, $monto_disponible, 0, 1, 'R', 1);
                    $x += 23;
                    $pdf->SetXY($x, $y);
                    $pdf->Cell(11, $hf, $pdisponible . ' %', 0, 1, 'R', 1);
                    $x += 11;
                ...
                $y  = $pdf->GetY();
                $x  = 5;
                $nb = $pdf->NbLines(73, $nompartida);
                $hf = 3 * $nb;
                $pdf->SetXY($x, $y);
                $pdf->Cell(20, $hf, $clasificador, 0, 1, 'C', 1);
                $x += 20;
                $pdf->SetXY($x, $y);
                $pdf->MultiCell(73, 3, $nompartida, 0, 'L', 1);
                $x += 73;
                if ($campos[0]) {
                    $pdf->SetXY($x, $y);
                    $pdf->Cell(23, $hf, $monto_original, 0, 1, 'R', 1);
                ...
                if ($num_rows_rendicion != 0) {
                    while ($field_rendicion = mysql_fetch_array($query_rendicion)) {
                        ...
                        $y  = $pdf->GetY();
                        $x  = 5;
                        $nb = $pdf->NbLines(73, $field_rendicion['Fecha'] . '-' . utf8_decode($field_rendicion['concepto']));
                        $hf = 3 * $nb;
                        $pdf->SetXY($x, $y);
                        $pdf->Cell(20, $hf, '', 0, 1, 'C', 1);
                        $x += 20;
                        $pdf->SetXY($x, $y);
                        $pdf->MultiCell(73, 3, $field_rendicion['Fecha'] . '-' . utf8_decode($field_rendicion['concepto']), 0, 'L', 1);
                        $x += 73;
                        if ($campos[0]) {
                            $pdf->SetXY($x, $y);
                            $pdf->Cell(23, $hf, '', 0, 1, 'R', 1);
                    ...
                    for ($k = 0; $k < $rows_detalle; $k++) {
                        ...
                        $y  = $pdf->GetY();
                        $x  = 5;
                        $nb = $pdf->NbLines(73, utf8_decode($fecha_solicitud . ' - ' . $detalle['tipo']));
                        $hf = 3 * $nb;
                        $pdf->SetXY($x, $y);
                        $pdf->Cell(20, $hf, $detalle['nro_solicitud'], 0, 1, 'C', 1);
                        $x += 20;
                        $pdf->SetXY($x, $y);
                        $pdf->MultiCell(73, 3, utf8_decode($fecha_solicitud . ' - ' . $detalle['tipo']), 0, 'L', 1);
                        $x += 73;
                        if ($campos[0]) {
                            $pdf->SetXY($x, $y);
                            $pdf->Cell(23, $hf, '', 0, 1, 'R', 1);
    ...
    case "resumen_actividades":
        ...
        while ($field = mysql_fetch_array($query)) {
            ...
            if ($field["IdCategoria"] != $IdCategoria) {
                ...
                $y  = $pdf->GetY();
                $x  = 5;
                $nb = $pdf->NbLines(50, utf8_decode($Unidad));
                $hf = 3 * $nb;
                $pdf->SetXY($x, $y);
                $pdf->Cell(20, $hf, $CodCategoria, 0, 1, 'C', 1);
                $x += 20;
                $pdf->SetXY($x, $y);
                $pdf->MultiCell(50, 3, utf8_decode($Unidad), 0, 'L', 1);
                $x += 50;
                if ($campos[0]) {
                    $pdf->SetXY($x, $y);
                    $pdf->Cell(23, $hf, $sum_formulado, 0, 1, 'R', 1);
    ...
    case "consolidado_sector_resumido":
        ...
        consolidado_sector($pdf, $anio_fiscal, $nom_fuente_financiamiento, $nom_tipo_presupuesto, $fdesde, $fhasta);
        if ($_GET["idsector"] != 0) {
            $filtro = "AND (sector.idsector='" . $_GET["idsector"] . "')";
        }
        ...
        for ($i = 0; $i < $rows; $i++) {
            ...
            if ($field["IdSector"] != $IdSector) {
                ...
                $y  = $pdf->GetY();
                $x  = 5;
                $nb = $pdf->NbLines(83, utf8_decode($field["Sector"]));
                $hf = 3 * $nb;
                $pdf->SetXY($x, $y);
                $pdf->Cell(10, $hf, $field["CodSector"], 0, 1, 'C', 1);
                $x += 10;
                $pdf->SetXY($x, $y);
                $pdf->MultiCell(83, 3, utf8_decode($field["Sector"]), 0, 'L', 1);
                $x += 83;
        ...
        $pdf->Rect($x, $y + 2, $w, $h);
        //    IMPRIMO LOS TOTALES
        if ($total_sum_compromiso != 0 && $total_sum_actual != 0) {
            $total_tpcompromiso = $total_sum_compromiso * 100 / $total_sum_actual;
        } else {
            $total_tpcompromiso = 0;
        }

        if ($total_sum_causado != 0 && $total_sum_actual != 0) {
            $total_tpcausado = $total_sum_causado * 100 / $total_sum_actual;
        } else {
            $total_tpcausado = 0;
        }

        if ($total_sum_pagado != 0 && $total_sum_actual != 0) {
            $total_tppagado = $total_sum_pagado * 100 / $total_sum_actual;
        } else {
            $total_tppagado = 0;
        }

        if ($total_sum_disponible != 0 && $total_sum_actual != 0) {
            $total_tpdisponible = $total_sum_disponible * 100 / $total_sum_actual;
        } else {
            $total_tpdisponible = 0;
        }
        ...
        if ($campos[0]) {
            $pdf->SetXY($x, $y);
            $pdf->Cell(23, $hf, number_format($total_sum_formulado, 2, ',', '.'), 0, 1, 'R', 1);
            $x += 23;}
        if ($campos[1]) {
            $pdf->SetXY($x, $y);
            $pdf->Cell(23, $hf, number_format($total_sum_aumento, 2, ',', '.'), 0, 1, 'R', 1);
            $x += 23;}
        if ($campos[2]) {
            $pdf->SetXY($x, $y);
            $pdf->Cell(23, $hf, number_format($total_sum_disminucion, 2, ',', '.'), 0, 1, 'R', 1);
            $x += 23;}
        if ($campos[3]) {
            $pdf->SetXY($x, $y);
            $pdf->Cell(23, $hf, number_format($total_sum_modificado, 2, ',', '.'), 0, 1, 'R', 1);
            $x += 23;}
        if ($campos[4]) {
            $pdf->SetXY($x, $y);
            $pdf->Cell(23, $hf, number_format($total_sum_actual, 2, ',', '.'), 0, 1, 'R', 1);
            $x += 23;}
        if ($campos[6]) {
            $pdf->SetXY($x, $y);
            $pdf->Cell(23, $hf, number_format($total_sum_compromiso, 2, ',', '.'), 0, 1, 'R', 1);
            $x += 23;
            $pdf->SetXY($x, $y);
            $pdf->Cell(11, $hf, number_format($total_tpcompromiso, 2, ',', '.') . ' %', 0, 1, 'R', 1);
            $x += 11;
        }
        if ($campos[7]) {
            $pdf->SetXY($x, $y);
            $pdf->Cell(23, $hf, number_format($total_sum_causado, 2, ',', '.'), 0, 1, 'R', 1);
            $x += 23;
            $pdf->SetXY($x, $y);
            $pdf->Cell(11, $hf, number_format($total_tpcausado, 2, ',', '.') . ' %', 0, 1, 'R', 1);
            $x += 11;
        }
        if ($campos[8]) {
            $pdf->SetXY($x, $y);
            $pdf->Cell(23, $hf, number_format($total_sum_pagado, 2, ',', '.'), 0, 1, 'R', 1);
            $x += 23;
            $pdf->SetXY($x, $y);
            $pdf->Cell(11, $hf, number_format($total_tppagado, 2, ',', '.') . ' %', 0, 1, 'R', 1);
            $x += 11;
        }
        if ($campos[9]) {
            $pdf->SetXY($x, $y);
            $pdf->Cell(23, $hf, number_format($total_sum_disponible, 2, ',', '.'), 0, 1, 'R', 1);
            $x += 23;
            $pdf->SetXY($x, $y);
            $pdf->Cell(11, $hf, number_format($total_tpdisponible, 2, ',', '.') . ' %', 0, 1, 'R', 1);
            $x += 11;
        }
        break;
        ...
        while ($field = mysql_fetch_array($query)) {
            ...
            if ($field["Tipo"] == "especifica") {
                ...
                for ($k = 0; $k < $rows_detalle; $k++) {
                    ...
                    $linea = $pdf->GetY();if ($linea > 190) {
                        movimientos_por_partida_tablas($pdf);
                        $pdf->SetY(40);
                        $pdf->SetDrawColor(255, 255, 255);
                        $pdf->SetFillColor(255, 255, 255);
                        $pdf->SetTextColor(0, 0, 0);}
    ...
    case "traslado_presupuestario":
        ...
        if ($field = mysql_fetch_array($query)) {
            $nsolicitud      = $field[0];
            list($a, $m, $d) = SPLIT('[/.-]', $field[1]);
            $fsolicitud      = $d . "/" . $m . "/" . $a;
            $nresolucion     = $field[2];
            list($a, $m, $d) = SPLIT('[/.-]', $field[3]);
            $fresolucion     = $d . "/" . $m . "/" . $a;
        ...
        if ($solicitud == "true") {
            ...
            $pdf->SetTextColor(0, 0, 0);
            $pdf->SetFont('Arial', '', 9);
            $pdf->Cell(25, 7, utf8_decode('Nro. Resolución: '), 0, 0, 'L');
            $pdf->SetFont('Arial', 'B', 9);
            $pdf->Cell(50, 7, $nresolucion, 0, 0, 'L');
            $pdf->SetFont('Arial', '', 9);
            $pdf->Cell(28, 7, utf8_decode('Fecha Resolución: '), 0, 0, 'L');
            $pdf->SetFont('Arial', 'B', 9);
            $pdf->Cell(102, 7, $fresolucion, 0, 0, 'L');
            $pdf->Ln(7);
            $pdf->SetFont('Arial', '', 9);
            $pdf->Cell(205, 7, utf8_decode('Justificación: '), 0, 1, 'L');
            ...
            $pdf->SetFont('Arial', '', 9);
            $pdf->Cell(12, 7, utf8_decode('Año:'), 0, 0, 'L');
            $pdf->SetFont('Arial', 'B', 9);
            $pdf->Cell(23, 7, $anio, 0, 0, 'L');
            $pdf->SetFont('Arial', '', 9);
            $pdf->Cell(27, 7, 'Total Disminuir: ', 0, 0, 'L');
            $pdf->SetFont('Arial', 'B', 9);
            $pdf->Cell(58, 7, $debito, 0, 0, 'L');
            $pdf->SetFont('Arial', '', 9);
            $pdf->Cell(27, 7, 'Total Aumentar: ', 0, 0, 'L');
            $pdf->SetFont('Arial', 'B', 9);
            $pdf->Cell(58, 7, $credito, 0, 0, 'L');
            //-----------
            ...
            while ($field = mysql_fetch_array($query)) {
                ...
                if ($linea > 250) {
                    $pag++;
                    anexo_traslado_presupuestario($pdf, $nsolicitud, $fsolicitud, $pag, "Partidas Disminuidas (Continuacion...)", $estado);
                    $pdf->SetY(61);}
                //
                $pdf->SetDrawColor(255, 255, 255);
                $pdf->SetFillColor(255, 255, 255);
                ...
                $sum_monto += $field[2];
                if ($field['codigo'] == "0000") {
                    $partida      = $field['partida'] . "." . $field['generica'] . "." . $field['especifica'] . "." . $field['sub_especifica'];
                    $denominacion = $field['NomPartida'];} else {
                    $partida      = $field['partida'] . "." . $field['generica'] . "." . $field['especifica'] . "." . $field['sub_especifica'] . " " . $field['codigo'];
                    $denominacion = $field['NomPartida'];}
            ...
            if ($y > 220) {
                $pag++;
                anexo_traslado_presupuestario($pdf, $nsolicitud, $fsolicitud, $pag, "Partidas Aumentadas (Continuacion...)", $estado);
                $pdf->SetY(60);} else {
                $pdf->SetXY(5, $y + 10);
                $pdf->SetFont('Arial', 'B', 10);
                $pdf->Cell(205, 5, 'Partidas Aumentadas', 0, 1, 'C');
                $pdf->SetDrawColor(0, 0, 0);
                $pdf->SetFillColor(255, 255, 255);
                $pdf->SetTextColor(0, 0, 0);
                $pdf->SetFont('Arial', 'B', 8);
            ...
            while ($field = mysql_fetch_array($query)) {
                ...
                if ($linea > 250) {
                    $pag++;
                    anexo_traslado_presupuestario_simulado($pdf, $nsolicitud, $fsolicitud, $pag, "Partidas Disminuidas (Continuacion...)", $estado);
                    $pdf->SetY(61);}
                //
                $pdf->SetDrawColor(255, 255, 255);
                $pdf->SetFillColor(255, 255, 255);
                ...
                if ($field['codigo'] == "0000") {
                    $partida      = $field['partida'] . "." . $field['generica'] . "." . $field['especifica'] . "." . $field['sub_especifica'];
                    $denominacion = $field['NomPartida'];} else {
                    $partida      = $field['partida'] . "." . $field['genercia'] . "." . $field['especifica'] . "." . $field['sub_especifica'] . " " . $field['codigo'];
                    $denominacion = $field['NomPartida'];}
            ...
            $sum_monto_actual              = 0;
            $sum_monto                     = 0;
            $sum_monto_ajustado            = 0;
            $sum_monto_disponible          = 0;
            $sum_monto_disponible_ajustado = 0;
            //-----------
            $y = $pdf->GetY();
            if ($y > 220) {
                $pag++;
                anexo_traslado_presupuestario_simulado($pdf, $nsolicitud, $fsolicitud, $pag, "Partidas Aumentadas (Continuacion...)", $estado);
                $pdf->SetY(61);} else {
                $pdf->SetXY(5, $y + 10);
                $pdf->SetFont('Arial', 'B', 10);
                $pdf->Cell(205, 5, 'Partidas Aumentadas', 0, 1, 'C');
    ...
    case "disminucion_presupuestaria":
        ...
        if ($solicitud == "true") {
            ...
            while ($field = mysql_fetch_array($query)) {
                ...
                if ($linea > 250) {
                    $pag++;
                    disminucion_presupuestaria($pdf, $nsolicitud, $fsolicitud, $pag, "Partidas Disminuidas (Continuacion...)", 50, $estado);
                    $pdf->SetY(61);}
                //
                $pdf->SetDrawColor(255, 255, 255);
                $pdf->SetFillColor(255, 255, 255);
            ...
            while ($field = mysql_fetch_array($query)) {
                ...
                if ($linea > 250) {
                    $pag++;
                    disminucion_presupuestaria_simulado($pdf, $nsolicitud, $fsolicitud, $pag, "Partidas Disminuidas (Continuacion...)", 50, $estado);
                    $pdf->SetY(61);}
                //
                $pdf->SetDrawColor(255, 255, 255);
                $pdf->SetFillColor(255, 255, 255);
    ...
    case "credito_adicional":
        ...
        if ($solicitud == "true") {
            ...
            while ($field = mysql_fetch_array($query)) {
                ...
                if ($linea > 250) {
                    $pag++;
                    credito_adicional($pdf, $nsolicitud, $fsolicitud, $pag, "Partidas Aumentadas (Continuacion...)", 50, $estado);
                    $pdf->SetY(61);}
                //
                $pdf->SetDrawColor(255, 255, 255);
                $pdf->SetFillColor(255, 255, 255);
            ...
            while ($field = mysql_fetch_array($query)) {
                ...
                if ($linea > 250) {
                    $pag++;
                    credito_adicional_simulado($pdf, $nsolicitud, $fsolicitud, $pag, "Partidas Aumentadas (Continuacion...)", 50, $estado);
                    $pdf->SetY(61);}
                //
                $pdf->SetDrawColor(255, 255, 255);
                $pdf->SetFillColor(255, 255, 255);
    ...
    case "rectificacion_partida":
        ...
        if ($solicitud == "true") {
            ...
            $pdf->Cell(23, 7, $anio, 0, 0, 'L');
            $pdf->SetFont('Arial', '', 9);
            $pdf->Cell(30, 7, 'Total Rectificadoras: ', 0, 0, 'L');
            $pdf->SetFont('Arial', 'B', 9);
            $pdf->Cell(58, 7, $debito, 0, 0, 'L');
            $pdf->SetFont('Arial', '', 9);
            $pdf->Cell(27, 7, 'Total Receptoras: ', 0, 0, 'L');
            $pdf->SetFont('Arial', 'B', 9);
            $pdf->Cell(58, 7, $credito, 0, 0, 'L');
            //-----------
            ...
            while ($field = mysql_fetch_array($query)) {
                ...
                if ($linea > 250) {
                    $pag++;
                    anexo_rectificacion_partida($pdf, $nsolicitud, $fsolicitud, $pag, "Partidas Rectificadoras (Continuacion...)", $estado);
                    $pdf->SetY(61);}
                //
                $pdf->SetDrawColor(255, 255, 255);
                $pdf->SetFillColor(255, 255, 255);
            ...
            if ($y > 220) {
                $pag++;
                anexo_rectificacion_partida($pdf, $nsolicitud, $fsolicitud, $pag, "Partidas Receptoras (Continuacion...)", $estado);
                $pdf->SetY(61);} else {
                $pdf->SetXY(5, $y + 10);
                $pdf->SetFont('Arial', 'B', 10);
                $pdf->Cell(205, 5, 'Partidas Receptoras', 0, 1, 'C');
                $pdf->SetDrawColor(0, 0, 0);
                $pdf->SetFillColor(255, 255, 255);
                $pdf->SetTextColor(0, 0, 0);
                $pdf->SetFont('Arial', 'B', 8);
            ...
            while ($field = mysql_fetch_array($query)) {
                ...
                if ($linea > 250) {
                    $pag++;
                    anexo_rectificacion_partida_simulado($pdf, $nsolicitud, $fsolicitud, $pag, "Partidas Rectificadoras (Continuacion...)", $estado);
                    $pdf->SetY(61);}
                //
                $pdf->SetDrawColor(255, 255, 255);
                $pdf->SetFillColor(255, 255, 255);
            ...
            if ($y > 220) {
                $pag++;
                anexo_rectificacion_partida_simulado($pdf, $nsolicitud, $fsolicitud, $pag, "Partidas Receptoras (Continuacion...)", $estado);
                $pdf->SetY(61);} else {
                $pdf->SetXY(5, $y + 10);
                $pdf->SetFont('Arial', 'B', 10);
                $pdf->Cell(205, 5, 'Partidas Receptoras', 0, 1, 'C');
    ...
    case "compromisos_en_transito":
        ...
        while ($field = mysql_fetch_array($query)) {
            ...
            if (($linea + $alto) > 260 || $i == 0 || $idcategoria != $field['idcategoria_programatica']) {
                if ($i != 0) {
                    $alto = getH($pdf, 4, 70, $field['justificacion']);
                }

                if (($linea + $alto) > 260 || $i == 0) {
                    compromisos_en_transito($pdf);
                }
    ...
    case "consolidado_agrupado":
        ...
        $nom_tipo_presupuesto      = $field['TipoPresupuesto'];
        //    ---------------------------------------------
        if ($idcategoria_desde != "" && $idcategoria_hasta != "") {
            $filtro = "AND (categoria_programatica.idcategoria_programatica >= '" . $idcategoria_desde . "' AND categoria_programatica.idcategoria_programatica <= '" . $idcategoria_hasta . "')";
        } elseif ($idcategoria_desde != "") {
            $filtro = "AND (categoria_programatica.idcategoria_programatica >= '" . $idcategoria_desde . "')";
        } elseif ($idcategoria_hasta != "") {
            $filtro = "AND categoria_programatica.idcategoria_programatica <= '" . $idcategoria_hasta . "')";
        }
        ...
        for ($j = 1; $j <= $rows; $j++) {
            ...
            if ($resta_disponible == 0) {
                ...
                $pdisponible = (float) ((($resta_disponible) * 100) / $monto_actual);
            }
            ...
            if ($field["Tipo"] == "partida") {
                ...
                if ($field['codordinal'] == "0000") {
                    ...
                    $y  = $pdf->GetY();
                    $x  = 5;
                    $nb = $pdf->NbLines(50, utf8_decode($field['codordinal'] . ' ' . $field['nomordinal']));
                    $hf = 3 * $nb;
                    $pdf->SetXY($x, $y);
                    $pdf->Cell(20, $hf, $clasificador, 0, 1, 'C', 1);
                    $x += 20;
                    $pdf->SetXY($x, $y);
                    $pdf->MultiCell(50, 3, utf8_decode($field['codordinal'] . ' ' . $field['nomordinal']), 0, 'L', 1);
                    $x += 50;
                    if ($campos[0]) {
                        $pdf->SetXY($x, $y);
                        $pdf->Cell(23, $hf, $formulado, 0, 1, 'R', 1);
        ...
        if ($total_compromiso == 0 || $total_ajustado == 0) {
            $total_pcompromiso = 0;
        } else {
            $total_pcompromiso = (float) (($total_compromiso * 100) / $total_ajustado);
        }

        if ($total_causado == 0 || $total_ajustado == 0) {
            $total_pcausado = 0;
        } else {
            $total_pcausado = (float) (($total_causado * 100) / $total_ajustado);
        }

        if ($total_pagado == 0 || $total_ajustado == 0) {
            $total_ppagado = 0;
        } else {
            $total_ppagado = (float) (($total_pagado * 100) / $total_ajustado);
        }

        if ($total_disponible == 0) {
            $total_pdisponible = 0;
        } else {
            $total_pdisponible = (float) ((($total_disponible) * 100) / $total_ajustado);
        }
