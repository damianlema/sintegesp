...
switch ($nombre) {
    ...
    case "filtro_solicitud_cotizacion":
        ...
        if ($_GET['idbeneficiario'] != "") {
            $filtro        = " AND (beneficiarios.idbeneficiarios='" . $_GET['idbeneficiario'] . "') ";
            $dbeneficiario = 1;
            $head          = 2;}
        if ($_GET['idarticulo'] != "") {
            $filtro .= " AND (articulos_solicitud_cotizacion.idarticulos_servicios='" . $_GET['idarticulo'] . "') ";
            $darticulo = 1;
            if ($dbeneficiario == 1) {
                $head = 2;
            } else {
        ...
        if ($_GET['desde'] != "" && $_GET['hasta'] != "") {
            list($d, $m, $a) = SPLIT('[/.-]', $_GET['desde']);
            $fecha_desde     = $a . "-" . $m . "-" . $d;
            list($d, $m, $a) = SPLIT('[/.-]', $_GET['hasta']);
            $fecha_hasta     = $a . "-" . $m . "-" . $d;
            $filtro .= " AND (solicitud_cotizacion.fecha_solicitud>='" . $fecha_desde . "' AND solicitud_cotizacion.fecha_solicitud<='" . $fecha_hasta . "') ";
            $dperiodo = 1;
            if ($dbeneficiario == 1) {
                $head = 2;
            } else {
        ...
        if ($_GET['idtipo'] != "0") {
            $filtro .= " AND (tipos_documentos.idtipos_documentos='" . $_GET['idtipo'] . "') ";
            $dtipo = 1;
            if ($dbeneficiario == 1) {
                $head = 4;
            } else {
        ...
        if ($_GET['idestado'] != "0") {
            $filtro .= " AND (solicitud_cotizacion.estado='" . $_GET['idestado'] . "') ";
            $destado = 1;
            if ($head == 0) {
                $head = 5;
            } elseif ($head == 2) {
        ...
        if ($head == 1) {
            for ($i = 0; $i < $rows; $i++) {
                ...
                list($a, $m, $d) = SPLIT('[/.-]', $field['fecha_solicitud']);
                $fecha           = $d . "/" . $m . "/" . $a;
                ...
                if ($i == 0) {
                    filtro_solicitud_cotizacion($pdf, $head, "", $_GET['desde'], $_GET['hasta'], "", $articulo, "");
                }
        ...
        elseif ($head == 2) {
            for ($i = 0; $i < $rows; $i++) {
                ...
                if ($i == 0) {
                    filtro_solicitud_cotizacion($pdf, $head, $beneficiario, $_GET['desde'], $_GET['hasta'], "", $articulo, "");
                }
        ...
        elseif ($head == 3) {
            for ($i = 0; $i < $rows; $i++) {
                ...
                if ($i == 0) {
                    filtro_solicitud_cotizacion($pdf, $head, "", $_GET['desde'], $_GET['hasta'], $tipo, $articulo, "");
                }
        ...
        elseif ($head == 4) {
            for ($i = 0; $i < $rows; $i++) {
                ...
                if ($i == 0) {
                    filtro_solicitud_cotizacion($pdf, $head, $beneficiario, $_GET['desde'], $_GET['hasta'], $tipo, $articulo, "");
                }
        ...
        elseif ($head == 5) {
            for ($i = 0; $i < $rows; $i++) {
                ...
                if ($i == 0) {
                    filtro_solicitud_cotizacion($pdf, $head, "", $_GET['desde'], $_GET['hasta'], "", $articulo, $estado);
                }
        ...
        elseif ($head == 6) {
            for ($i = 0; $i < $rows; $i++) {
                ...
                if ($i == 0) {
                    filtro_solicitud_cotizacion($pdf, $head, $beneficiario, $_GET['desde'], $_GET['hasta'], "", $articulo, $estado);
                }
        ...
        elseif ($head == 7) {
            for ($i = 0; $i < $rows; $i++) {
                ...
                if ($i == 0) {
                    filtro_solicitud_cotizacion($pdf, $head, "", $_GET['desde'], $_GET['hasta'], $tipo, $articulo, $estado);
                }
        ...
        elseif ($head == 8) {
            for ($i = 0; $i < $rows; $i++) {
                ...
                if ($i == 0) {
                    filtro_solicitud_cotizacion($pdf, $head, $beneficiario, $_GET['desde'], $_GET['hasta'], $tipo, $articulo, $estado);
                }
    ...
    case "filtro_compromisos":
        ...
        ////////////
        if ($_GET['idbeneficiario'] != "") {
            $filtro        = " AND (b.idbeneficiarios='" . $_GET['idbeneficiario'] . "') ";
            $dbeneficiario = 1;
            $head          = 2;}
        if ($_GET['idcategoria'] != "") {
            $filtro .= " AND (c.idcategoria_programatica='" . $_GET['idcategoria'] . "') ";
            $dcategoria = 1;
            if ($dbeneficiario == 1) {
                $head = 2;
            } else {
        ...
        if ($_GET['idarticulo'] != "") {
            $filtro .= " AND (a.idarticulos_servicios='" . $_GET['idarticulo'] . "') ";
            $darticulo = 1;
            if ($dbeneficiario == 1) {
                $head = 2;
            } else {
        ...
        if ($_GET['desde'] != "" && $_GET['hasta'] != "") {
            ...
            list($d, $m, $a) = SPLIT('[/.-]', $_GET['hasta']);
            $fecha_hasta     = $a . "/" . $m . "/" . $d;
            $filtro .= " AND (ocs.fecha_orden>='" . $desde . "' AND ocs.fecha_orden<='" . $hasta . "') ";
            $dperiodo = 1;
            if ($dbeneficiario == 1) {
                $head = 2;
            } else {
        ...
        if ($_GET['idtipo'] != "0") {
            $filtro .= " AND (td.idtipos_documentos='" . $_GET['idtipo'] . "') ";
            $dtipo = 1;
            if ($dbeneficiario == 1) {
                $head = 4;
            } else {
        ...
        if ($_GET['idestado'] != "0") {
            $filtro .= " AND (ocs.estado='" . $_GET['idestado'] . "') ";
            $destado = 1;
            if ($head == 0) {
                $head = 5;
            } elseif ($head == 2) {
        ...
        if ($_SESSION['modulo'] == "1") {
            $or = "OR td.modulo LIKE '%-13-%'";
        } elseif ($_SESSION['modulo'] == "13") {
            $or = "OR td.modulo LIKE '%-1-%'";
        } else {
            $or = "";
        }
        ...
        if ($head == 1) {
            for ($i = 0; $i < $rows; $i++) {
                ...
                if ($i == 0) {
                    filtro_compromisos_head($pdf, $head, "", $categoria, $_GET['desde'], $_GET['hasta'], "", $articulo, "");
                }
        ...
        elseif ($head == 2) {
            for ($i = 0; $i < $rows; $i++) {
                ...
                if ($i == 0) {
                    filtro_compromisos_head($pdf, $head, $beneficiario, $categoria, $_GET['desde'], $_GET['hasta'], "", $articulo, "");
                }
        ...
        elseif ($head == 3) {
            for ($i = 0; $i < $rows; $i++) {
                ...
                if ($i == 0) {
                    filtro_compromisos_head($pdf, $head, "", $categoria, $_GET['desde'], $_GET['hasta'], $tipo, $articulo, "");
                }
        ...
        elseif ($head == 4) {
            for ($i = 0; $i < $rows; $i++) {
                ...
                if ($i == 0) {
                    filtro_compromisos_head($pdf, $head, $beneficiario, $categoria, $_GET['desde'], $_GET['hasta'], $tipo, $articulo, "");
                }
        ...
        elseif ($head == 5) {
            for ($i = 0; $i < $rows; $i++) {
                ...
                if ($i == 0) {
                    filtro_compromisos_head($pdf, $head, "", $categoria, $_GET['desde'], $_GET['hasta'], "", $articulo, $estado);
                }
        ...
        elseif ($head == 6) {
            for ($i = 0; $i < $rows; $i++) {
                ...
                if ($i == 0) {
                    filtro_compromisos_head($pdf, $head, $beneficiario, $categoria, $_GET['desde'], $_GET['hasta'], "", $articulo, $estado);
                }
        ...
        elseif ($head == 7) {
            for ($i = 0; $i < $rows; $i++) {
                ...
                if ($i == 0) {
                    filtro_compromisos_head($pdf, $head, "", $categoria, $_GET['desde'], $_GET['hasta'], $tipo, $articulo, $estado);
                }
        ...
        elseif ($head == 8) {
            for ($i = 0; $i < $rows; $i++) {
                ...
                if ($i == 0) {
                    filtro_compromisos_head($pdf, $head, $beneficiario, $categoria, $_GET['desde'], $_GET['hasta'], $tipo, $articulo, $estado);
                }
    ...
    case "filtro_orden_pago":
        ...
        if ($_GET['idfuente_financiamiento'] != '0') {
            $filtro .= " AND (orden_pago.idfuente_financiamiento = '" . $_GET['idfuente_financiamiento'] . "') ";
            $dcategoria = 1;
        ...
        if ($_GET['desde'] != "" && $_GET['hasta'] != "") {
            ...
            $fecha_desde     = $a . "-" . $m . "-" . $d;
            list($a, $m, $d) = SPLIT('[/.-]', $_GET['hasta']);
            $fecha_hasta     = $a . "-" . $m . "-" . $d;
            $filtro .= " AND (orden_pago.fecha_orden>='" . $fecha_desde . "' AND orden_pago.fecha_orden<='" . $fecha_hasta . "') ";
            $dperiodo = 1;
            if ($dbeneficiario == 1) {
                $head = 2;
            } else {
        ...
        if ($_GET['idtipo'] != "0") {
            $filtro .= " AND (orden_pago.tipo ='" . $_GET['idtipo'] . "') ";
            $dtipo = 1;
            if ($dbeneficiario == 1) {
                $head = 4;
            } else {
        ...
        if ($_GET['idestado'] != "0") {
            if ($_GET['idestado'] != 'procesadapagada') {
                if ($_GET['idestado'] == 'procesado') {
                    $filtro .= " AND (orden_pago.estado='procesado') ";
                    $destado = 1;
                    $estado  = 'PROCESADA';
                }
                if ($_GET['idestado'] == 'conformado') {
                    $filtro .= " AND (orden_pago.estado='conformado') ";
                    $destado = 1;
                    $estado  = 'CONFORMADA';
                }
                if ($_GET['idestado'] == 'devuelto') {
                    $filtro .= " AND (orden_pago.estado='devuelto') ";
                    $destado = 1;
                    $estado  = 'DEVUELTA';
                }
                if ($_GET['idestado'] == 'anulado') {
                    $filtro .= " AND (orden_pago.estado='anulado') ";
                    $destado = 1;
                    $estado  = 'ANULADA';
                }
                if ($_GET['idestado'] == 'pagada') {
                    $filtro .= " AND (orden_pago.estado='pagada') ";
                    $destado = 1;
                    $estado  = 'PAGADA';
                }
            } else {
                $filtro .= " AND (orden_pago.estado='procesado' or orden_pago.estado='pagada') ";
                $destado = 1;
        ...
        if ($head == 1) {
            for ($i = 0; $i < $rows; $i++) {
                ...
                if ($i == 0) {
                    filtro_orden_pago($pdf, $head, "", $categoria, $_GET['desde'], $_GET['hasta'], "", $estado, $nombremodulo, $fuente);
                }
    ...
    case "ordenpago":
        ...
        if ((in_array(1, $modulo) == true or in_array(13, $modulo) == true) and $num_tiene_retencion == 0) {
            ...
            $pdf->Cell(20, 5, 'ASIGNACIONES: ', 0, 0, 'R');
            $pdf->SetFont('Arial', 'B', 12);
            $pdf->Cell(30, 5, $sub_total, 0, 0, 'R');
            $pdf->SetXY(160, 144);
            $pdf->SetFont('Arial', 'B', 9);
            $pdf->Cell(20, 5, 'DEDUCCIONES: ', 0, 0, 'R');
            $pdf->SetFont('Arial', 'B', 12);
            $pdf->Cell(30, 5, $exento, 0, 0, 'R');
            $pdf->SetXY(160, 152);
            $pdf->SetFont('Arial', 'B', 9);
            ...
            $pdf->SetXY(160, 144);
            $pdf->SetFont('Arial', 'B', 9);
            $pdf->Cell(20, 5, 'RETENCIONES: ', 0, 0, 'R');
            $pdf->SetFont('Arial', 'B', 12);
            $pdf->Cell(30, 5, $total_retenido, 0, 0, 'R');
            $pdf->SetXY(160, 152);
            $pdf->SetFont('Arial', 'B', 9);
            $pdf->Cell(20, 5, 'TOTAL A PAGAR: ', 0, 0, 'R');
            $pdf->SetFont('Arial', 'B', 12);
            $pdf->Cell(30, 5, $total_pagar, 0, 0, 'R');
        }
        ...
        $pdf->SetFont('Arial', 'B', 8);
        $pdf->Cell(165, 5, utf8_decode($beneficiario), 0, 0, 'L');
        $pdf->SetXY(5, 100);
        $pdf->SetDrawColor(0, 0, 0);
        $pdf->SetFillColor(255, 255, 255);
        $pdf->SetTextColor(0, 0, 0);
        $pdf->SetFont('Arial', 'B', 8);
        $pdf->Cell(205, 5, 'CONCEPTO DETALLADO:', 1, 1, 'L', 1);
        $pdf->Ln(2);
        $pdf->SetTextColor(0, 0, 0);
        ...
        while ($field_retenciones = mysql_fetch_array($query_retenciones)) {
            ...
            if ($field_retenciones['porcentaje_aplicado'] == 0) {
                $sobre      = "";
                $porcentaje = "";} else {
        ...
        if ($rows_retenciones > 5) {
            $linea_mas = $rows_retenciones - 5;
        } else {
            $linea_mas = 0;
        }
        ...
        if ($rows > (5 - $linea_mas)) {
            ...
            for ($i = 1; $i <= $rows; $i++) {
                ...
                $w1 = 25;
                $pdf->SetXY($x1 - 5, $y);
                $pdf->MultiCell($w1, $l, $field['codigo'], 0, 'C');
                $h  = 5;
                $l  = 4;
                $x1 = 35.00125;
                $w1 = 35;
                $pdf->SetXY($x1 - 5, $y);
                $pdf->MultiCell($w1, $l, $partida, 0, 'C');
                $h  = 5;
                $l  = 4;
                $x1 = 70.00125;
                $w1 = 110;
                $pdf->SetXY($x1 - 5, $y);
                $pdf->MultiCell($w1, $l, utf8_decode($descripcion), 0, 'L');
                $h  = 5;
                $l  = 4;
                $x1 = 180.00125;
                $w1 = 35;
                $pdf->SetXY($x1 - 5, $y);
                $pdf->MultiCell($w1, $l, $monto, 0, 'R');
                if ($y > 250) {
                    $pag++;
                    ordenpago_anexo($pdf, $numero, $fecha, $pag, $idtipo_documento);
                    $pdf->SetXY(5, 35);
            ...
            if (mysql_num_rows($sql_asiento_contable) > 0) {
                ...
                if ($num_cuentas_asiento <= 2 and $y < 230) {
                    ...
                    $pdf->SetFont('Arial', 'B', 9);
                    $pdf->SetXY(5, $y);
                    $pdf->Cell(50, 5, utf8_decode('AFECTACION CONTABLE'), 0, 1, 'L');
                    $y = $pdf->GetY();
                    $pdf->SetY($y);
                    $pdf->SetDrawColor(0, 0, 0);
                    $pdf->SetFillColor(255, 255, 255);
                    ...
                    for ($i = 1; $i <= $num_cuentas_asiento; $i++) {
                        ...
                        $w1 = 25;
                        $pdf->SetXY($x1 - 5, $y);
                        $pdf->MultiCell($w1, $l, $bus_cuenta["codigo"], 0, 'L');
                        $h  = 5;
                        $l  = 4;
                        $x1 = 35.00125;
                        $w1 = 120;
                        $pdf->SetXY($x1 - 5, $y);
                        $pdf->MultiCell($w1, $l, substr(utf8_decode($denominacion), 0, 50), 0, 'L');
                        $h  = 5;
                        $l  = 4;
                        $x1 = 165.00125;
                        $w1 = 30;
                        $pdf->SetXY($x1 - 5, $y);
                        $pdf->MultiCell($w1, $l, $monto_debe, 0, 'C');
                        $h  = 5;
                        $l  = 4;
                        $x1 = 185.00125;
                        $w1 = 30;
                        $pdf->SetXY($x1 - 5, $y);
                        $pdf->MultiCell($w1, $l, $monto_haber, 0, 'R');
                    }
        ...
        if ($rows != 0) {
            ...
            for ($i = 1; $i <= $rows; $i++) {
                ...
                list($a, $m, $d) = SPLIT('[/.-]', $f_factura);
                $fecha_factura   = $d . "/" . $m . "/" . $a;if ($fecha_factura == "//") {
                    $fecha_factura = "";
                }
                ...
                if ($field['estado'] == "parcial") {
                    $exento = number_format($field['exento_op'], 2, ',', '.');
                    $sum_exento += $field['exento_op'];
                    $sub_total = number_format($field['sub_total_op'], 2, ',', '.');
                    $sum_sub_total += $field['sub_total_op'];
                    $impuesto = number_format($field['impuesto_op'], 2, ',', '.');
                    $sum_impuesto += $field['impuesto_op'];
                    $total = number_format($field['total_op'], 2, ',', '.');
                    $sum_total += $field['total_op'];
                    $retencion = number_format($field['total_retenido_op'], 2, ',', '.');
                    $sum_retencion += $field['total_retenido_op'];
                    $pagar = $field['total_op'] - $field['total_retenido_op'];
                    $sum_total_pagar += $pagar;
                    $total_pagar = number_format($pagar, 2, ',', '.');
                } else {
                    $exento = number_format($field['exento'], 2, ',', '.');
                    $sum_exento += $field['exento'];
                    $sub_total = number_format($field['sub_total'], 2, ',', '.');
                    $sum_sub_total += $field['sub_total'];
                    $impuesto = number_format($field['impuesto'], 2, ',', '.');
                    $sum_impuesto += $field['impuesto'];
                    $total = number_format($field['total'], 2, ',', '.');
                    $sum_total += $field['total'];
                    $retencion = number_format($field['total_retenido'], 2, ',', '.');
                    $sum_retencion += $field['total_retenido'];
                    $pagar = $field['total'] - $field['total_retenido'];
                    $sum_total_pagar += $pagar;
                    $total_pagar = number_format($pagar, 2, ',', '.');
                }
                $pdf->SetDrawColor(255, 255, 255);
    ...
    case "ordenes_pago_por_financiamiento":
        ...
        $filtro = "";
        if ($anio_fiscal != "0") {
            $filtro .= " AND op.anio = '" . $anio_fiscal . "' ";
        }

        if ($tipo_presupuesto != "0") {
            $filtro .= " AND op.idtipo_presupuesto = '" . $tipo_presupuesto . "' ";
        }

        if ($financiamiento != "0") {
            $filtro .= " AND op.idfuente_financiamiento = '" . $financiamiento . "' ";
        }

        if ($tipo != "0") {
            $filtro .= " AND op.tipo = '" . $tipo . "' ";
        }

        if ($estado != "0") {
            $filtro .= " AND op.estado = '" . $estado . "' ";
        }

        if ($desde != "") {
            $filtro .= " AND op.fecha_orden >= '" . $desde . "'";
        }

        if ($hasta != "") {
            $filtro .= " AND op.fecha_orden <= '" . $hasta . "'";
        }
