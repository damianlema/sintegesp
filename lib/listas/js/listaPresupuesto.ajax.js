...
$(document).ready(function() {
	...
	var dataString = 'ejecutar=llena_tipo_presupuesto';
	$.ajax({
		type: "POST",
	...
	var dataString = 'ejecutar=llena_fuente_financiamiento';
	$.ajax({
		type: "POST",
		url: "../../../lib/listas/controlador/listaPresupuesto.Controller.php",
		data: dataString,
	...
	var dataString = 'ejecutar=llena_categoria_programatica';
	$.ajax({
		type: "POST",
		url: "../../../lib/listas/controlador/listaPresupuesto.Controller.php",
		data: dataString,
...
//
	$("#btnBuscar").click(function() {
		...
		var dataString = 	'tipo_presupuesto=' + tipo_presupuesto +
							'&fuente_financiamiento=' + fuente_financiamiento +
							'&categoria_programatica=' + categoria_programatica +
							'&texto_busqueda=' + texto_busqueda +
							'&ejecutar=buscar_lista_presupuesto';
		$.ajax({
			type: "POST",
			url: "../../../lib/listas/controlador/listaPresupuesto.Controller.php",
			data: dataString,
			...
			error: function(xhr, status){
				alert("error filtro de busqueda");
			}
		});
	});