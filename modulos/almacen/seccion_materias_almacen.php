<script src="modulos/almacen/js/seccion_materias_almacen_ajax.js"></script>
    <br>
<h4 align=center>
Secciones</h4>
...
<table width="60%" border="0" align="center">
  <tr>
    ...
    <td><label>
      ...
      <?
      $sql_consultar_subgrupos = mysql_query("select * from subgrupo_materias_almacen");
	  $i=0;
	  while($bus_consultar_subgrupos = mysql_fetch_array($sql_consultar_subgrupos)){
		...
		?>
		<option onClick="document.getElementById('codigoSubGrupo').innerHTML='<?=$bus_consultar_subgrupos["codigo"]?>-', document.getElementById('codigoHidden').value='<?=$bus_consultar_subgrupos["codigo"]?>-'" value="<?=$bus_consultar_subgrupos["idsubgrupo_materias_almacen"]?>">
			<?=$bus_consultar_subgrupos["codigo"]." - ".$bus_consultar_subgrupos["denominacion"]?>
        </option>
		<?
	  }
	  ?>
...
<?
$sql_consulta = mysql_query("select * from seccion_materias_almacen");
					...
					<td align="center">
	  				  ...
	  				  <thead>
							...
							<tr bgcolor='#e7dfce' onMouseOver="setRowColor(this, 0, 'over', '#e7dfce', '#EAFFEA', '#FFFFAA')" onMouseOut="setRowColor(this, 0, 'out', '#e7dfce', '#EAFFEA', '#FFFFAA')">
                                ...
                                <td class='Browse'><?=utf8_decode($bus_consulta["denominacion"])?></td>
