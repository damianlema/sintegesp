<script src="modulos/almacen/js/volumen_materia_ajax.js"></script>
	<br>
	<h4 align=center>Volumen</h4>
...
<br />
<br />
<input type="hidden" id="idvolumen" name="idvolumen">
...
<table width="35%" border="0" align="center" cellpadding="4" cellspacing="0">
  ...
  <tr>
    <td colspan="2"><table width="50%" border="0" align="center" cellpadding="4" cellspacing="0">
      <tr>
        <td align="center">
          <input type="button" name="boton_ingresar" id="boton_ingresar" value="Ingresar" class="button" onClick="ingresarVolumen()">
        </td>
        <td align="center">
          <input type="button" name="boton_modificar" id="boton_modificar" value="Modificar" class="button" style="display:none" onClick="modificarVolumen()">
        </td>
        <td align="center">
          <input type="button" name="boton_eliminar" id="boton_eliminar" value="Eliminar" class="button" style="display:none" onClick="eliminarVolumen()">
        </td>
        </tr>
    </table></td>
  </tr>
