<script src="modulos/almacen/js/condicion_conservacion_materia_ajax.js"></script>
	<br>
	<h4 align=center>Condici&oacute;n de Conservaci&oacute;n</h4>
...
<br />
<br />
<input type="hidden" id="idcondicion_conservacion" name="idcondicion_conservacion">
