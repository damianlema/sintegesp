<script src="modulos/almacen/js/consultar_materia_ajax.js"></script>
		...
		<table align=center cellpadding=2 cellspacing=0 width="80%">
			<tr>
                ...
                <select name="tipo_movimiento_almacen" id="tipo_movimiento_almacen">
				  <?
                  $sql_tipo = mysql_query("select * from tipo_movimiento_almacen where afecta = '1' order by codigo")or die(mysql_error());
    ...
    <table width="52%" border="0" align="center">
      ...
      <tr>
        ...
        <?
          ...
          ?>
           <select name="iddistribucion_almacen" id="iddistribucion_almacen" style="width:90%">
            <?
...
<br>
   ...
   <!-- ***************************** RELACION DENOMINACION ARTIUCULOS CON QUE SE COMPRO LA MATERIA *********************************************-->
	...
	<script> document.getElementById('codigo_materia').focus() </script>
