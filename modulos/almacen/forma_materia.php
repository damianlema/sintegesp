<script src="modulos/almacen/js/forma_materia_ajax.js"></script>
	<br>
...
<br />
<br />
<input type="hidden" id="idforma" name="idforma">
...
<table width="35%" border="0" align="center" cellpadding="4" cellspacing="0">
  ...
  <tr>
    <td colspan="2"><table width="50%" border="0" align="center" cellpadding="4" cellspacing="0">
      <tr>
        <td align="center">
          <input type="button" name="boton_ingresar" id="boton_ingresar" value="Ingresar" class="button" onClick="ingresarForma()">
        </td>
        <td align="center">
          <input type="button" name="boton_modificar" id="boton_modificar" value="Modificar" class="button" style="display:none" onClick="modificarForma()">
        </td>
        <td align="center">
          <input type="button" name="boton_eliminar" id="boton_eliminar" value="Eliminar" class="button" style="display:none" onClick="eliminarForma()">
        </td>
        </tr>
    </table></td>
  </tr>
