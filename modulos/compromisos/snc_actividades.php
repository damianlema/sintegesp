...
if ($_GET["accion"] == 100 || $_GET["accion"] == 101){   // si entra para modificar o eliminar busca el registro para cargar los datos en el formulario
...
<body>
	<br>
	<h4 align=center>Segmentos</h4>
	<h2 class="sqlmVersion"></h2>
	<br>
<form id="frmsnc_actividades" action="principal.php?modulo=3&accion=<?=$_GET["accion"]?>" method="POST" enctype="multipart/form-data">	
...
<tr>
				...
				<td class=''><input type="text" name="sigla" maxlength="2" size="2" id="sigla" <?php echo 'value="'.$regsnc_actividades['sigla'].'"'; ?> onKeyUp="validarVacios('sigla', this.value, 'frmsnc_actividades')" onBlur="validarVacios('sigla', this.value, 'frmsnc_actividades')" autocomplete="OFF" style="padding:0px 20px 0px 0px;"></td>
			</tr>
				<td align='right' class='viewPropTitle'>Descripci&oacute;n:</td>
				<td class=''><input type="text" name="descripcion" maxlength="255" size="130" id="descripcion" <?php echo 'value="'.$regsnc_actividades['descripcion'].'"'; ?> onKeyUp="validarVacios('descripcion', this.value, 'frmsnc_actividades')" onBlur="validarVacios('descripcion', this.value, 'frmsnc_actividades')" autocomplete="OFF" style="padding:0px 20px 0px 0px;">
                &nbsp;<a href='principal.php?modulo=3&accion=79' class='Browse'><img src="imagenes/nuevo.png" border="0" title="Nuevo SNC Actividades"></a>
          	...
          	<tr>
                ...
                <td>
                	<select name="ordenarPor" id="ordenarPor">
                         ...
                         <option value="sigla">C&oacute;digo</option>
                    </select>               
                </td>
            </tr>
            <tr>
...
<?php
					...
					if($_GET["accion"] != 100 and $_GET["accion"] != 101 and in_array(99, $privilegios) == true){
						echo "<input align=center class='button' name='ingresar' type='submit' value='Ingresar'>";
					}
				
					if($_GET["accion"] == 101 and in_array($_GET["accion"], $privilegios) == true){
						echo "<input align=center class='button' name='modificar' type='submit' value='Modificar'>";
					}
				
					if($_GET["accion"] == 100 and in_array($_GET["accion"], $privilegios) == true){
						...
						<table class="Browse" align=center cellpadding="0" cellspacing="0" width="100%">
							<thead>
								<tr>
									...
									<td align="center" class="Browse">Segmentos</td>
						  ...
						  <tr bgcolor='#e7dfce' onMouseOver="setRowColor(this, 0, 'over', '#e7dfce', '#EAFFEA', '#FFFFAA')" onMouseOut="setRowColor(this, 0, 'out', '#e7dfce', '#EAFFEA', '#FFFFAA')">
								<?php
									...
									$c=$llenar_grilla["idsnc_actividades"];
										if(in_array(101, $privilegios) == true){
											echo "<td align='center' class='Browse' width='3%'><a href='principal.php?modulo=3&accion=101&c=$c' class='Browse'><img src='imagenes/modificar.png' border='0' alt='Modificar' title='Modificar'></a></td>";
										}
										if(in_array(100, $privilegios) == true){
									echo "<td align='center' class='Browse' width='3%'><a href='principal.php?modulo=3&accion=100&c=$c' class='Browse'><img src='imagenes/delete.png' border='0' alt='Borrar' title='Borrar'></a></td>";	
										}
									echo "</tr>";
									}
							}?>
...
if ($_POST){
	...
	if($_GET["accion"] == 99 and in_array(99, $privilegios) == true){
		if (mysql_num_rows($busca_existe_registro)>0){
			mensaje("Disculpe ya este registro existe");
			redirecciona("principal.php?modulo=3&accion=79");
		}else{
	...
	if ($_GET["accion"]==101 and in_array(101, $privilegios) ==  true and !$_POST["buscar"]){
	...
	if ($_GET["accion"] == 100 and in_array(100, $privilegios) == true and !$_POST["buscar"]){
