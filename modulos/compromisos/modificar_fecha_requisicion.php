<script src="modulos/compromisos/js/modificar_fecha_requisicion_ajax.js"></script>
    <br>
<h4 align=center>Modificar Fechas Requisicion</h4>
...
<tr>
    	<td width="112" align="center" class='viewPropTitle'>Numero de Requisicion</td>
      <td width="144"><input type="text" name="campoBuscar" id="campoBuscar"></td>
        <td width="93" align="center" class='viewPropTitle'>Tipo Requisicion</td>
        <td width="89">
			<select name="tipoOrden" id="tipoOrden">
            <?
            $sql_tipo_documento = mysql_query("select * from tipos_documentos where modulo like '%-3-%'");
