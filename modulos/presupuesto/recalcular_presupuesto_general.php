...
if($_POST){
$i=1;
echo "<strong>RECALCULANDO PRESUPUESTO GENERAL</strong><br /><span style='color:#FF0000'>Por favor no realice ninguna acción mientras este proceso culmina, al terminar el sistema le indicara que el proceso ha finalizado</span><br /><br><br>";
...
echo "<br /><br /><strong>FIN DEL PROCESO</strong><br>
Ya puede seguir usando el sistema normalmente <br />";
}else{
	?>
		<br>
<h4 align=center>Recalcular Presupuesto Completo</h4>
	<h2 class="sqlmVersion"></h2>
	<br>
	<br>
<br>
<form method="post">
	<center><input type="submit" id="boton_enviar" name="boton_enviar" value="Recalcular Presupuesto"></center>
</form>
	<?
}
?>
