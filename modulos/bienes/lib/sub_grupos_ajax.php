...
if($ejecutar == "ingresarSubGrupos"){
	$sql_ingresar_subgrupos = mysql_query("insert into subgrupo_catalogo_bienes(idgrupo_catalogo_bienes,
																			codigo,
																			denominacion,
																			status,
																			usuario,
...
$sql = "select * from subgrupo_catalogo_bienes ";
if($campo_buscar != ""){
...
if($ejecutar == "modificarSubGrupos"){
	$sql_editar_subgrupo = mysql_query("update subgrupo_catalogo_bienes set 
																	idgrupo_catalogo_bienes = '".$grupo."',
																	codigo = '".$codigo."',
																	denominacion = '".$denominacion."'
																	where idsubgrupo_catalogo_bienes = '".$id_subgrupo."'")or die(mysql_error());
...
if($ejecutar == "eliminarSubGrupos"){
	$sql_eliminar_subgrupo = mysql_query("delete from subgrupo_catalogo_bienes where idsubgrupo_catalogo_bienes = '".$id_subgrupo."'");
