...
function eliminar_retencion(idretenciones){
	
	var ajax=nuevoAjax();
	ajax.open("POST", "modulos/tributos/lib/retenciones_realizadas_ajax.php", true);
	...
	ajax.send("idretenciones="+idretenciones+"&ejecutar=eliminar_retencion");	
}
