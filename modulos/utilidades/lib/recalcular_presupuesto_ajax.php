...
if($ejecutar == "procesar"){
	...
	$sql_maestro_presupuesto = mysql_query("select * from maestro_presupuesto, clasificador_presupuestario 
													where maestro_presupuesto.idfuente_financiamiento = '".$idfuente_financiamiento."'
													and maestro_presupuesto.idtipo_presupuesto = '".$idtipo_presupuesto."'
													and maestro_presupuesto.anio = '".$anio."'
													and maestro_presupuesto.idordinal = '".$idordinal."'
													and maestro_presupuesto.idcategoria_programatica = '".$idcategoria_programatica."'
													and maestro_presupuesto.idclasificador_presupuestario = '".$idpartidas."'
													and clasificador_presupuestario.idclasificador_presupuestario = '".$idpartidas."'")or die("ERROR SELECCIONAR MAESTRO: ".mysql_error());
...
if ($bus_maestro_presupuesto["sub_especifica"] <> '00'){
	...
	$sql_maestro_presupuesto = mysql_query("select * from maestro_presupuesto, clasificador_presupuestario 
													...
													and clasificador_presupuestario.partida = '".$bus_maestro_presupuesto["partida"]."'
													and clasificador_presupuestario.generica = '".$bus_maestro_presupuesto["generica"]."'
													and clasificador_presupuestario.especifica = '".$bus_maestro_presupuesto["especifica"]."'
...
$sql_clasificador = mysql_query("select * from clasificador_presupuestario 
		...
		//echo " antes de compra ".$bus_maestroE["total_compromisos"];				
						$sql_actualizar_maestro = mysql_query("update maestro_presupuesto 
															set total_compromisos =  '0',
															total_disminucion = '0',
															total_aumento = '0',
															total_causados = '0',
															total_pagados = '0',
															reservado_disminuir = '0',
															solicitud_aumento = '0',
															pre_compromiso = '0'
...
/*	
	...
	//echo $bus_maestro_presupuesto["sub_especifica"];
