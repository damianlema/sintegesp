...
$sql_eliminar_articulos = mysql_query("delete from articulos_compra_servicio where idorden_compra_servicio = '".$id_orden_compra."'");
...
?>
	...
	$sql_orden_compra = mysql_query("select * from orden_compra_servicio, tipos_documentos 
												...
												and (tipos_documentos.modulo like '%-13-%' or tipos_documentos.modulo = 1) 
												order by orden_compra_servicio.fecha_elaboracion ASC");
    $i = 0;
