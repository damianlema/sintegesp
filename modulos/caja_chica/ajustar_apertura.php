<script src="modulos/caja_chica/js/ajustar_apertura_ajax.js"></script>
    <br>
<h4 align=center>Modificar Fecha de Apertura y Reposicion Caja Chica</h4>
...
<tr>
      ...
      <td width="144"><input type="text" name="campoBuscar" id="campoBuscar"></td>
        <td width="93" align="center" class='viewPropTitle'>Tipo Orden</td>
            ...
            <?
            $sql_tipo_documento = mysql_query("select * from tipos_documentos where modulo like '%-16-%'");
