<script src="modulos/caja_chica/js/eliminar_en_elaboracion_ajax.js"></script>
    <br>
<h4 align=center>Eliminar Aperturas y Reposiciones en Elaboracion</h4>
...
<div id="listaOrdenes">   
    <table align="center" class="Browse" cellpadding="0" cellspacing="0" >
        <thead>
            <tr>
                <!--<td class="Browse">&nbsp;</td>-->
               <td align="center" class="Browse">Tipo de Documento</td>
    ...
    $sql_orden_compra = mysql_query("select * from orden_compra_servicio, tipos_documentos 
												...
												and tipos_documentos.modulo like '%-16-%' order by fecha_elaboracion ASC");
    $i = 0;
    while($bus_orden_compra = mysql_fetch_array($sql_orden_compra)){
			...
			?>
            <td align="center" class='Browse'><?=$bus_orden_compra["descripcion"]?></td>
