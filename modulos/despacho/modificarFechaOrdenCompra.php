<script src="modulos/despacho/js/modificarFechaOrdenCompra_ajax.js"></script>
    <br>
...
<tr>
      ...
      <td width="144"><input type="text" name="campoBuscar" id="campoBuscar"></td>
        ...
        <td width="89">
            ...
            <?
            $sql_tipo_documento = mysql_query("select * from tipos_documentos where modulo like '%-12-%'");
