<script src="modulos/despacho/js/eliminarEnElaboracion_ajax.js"></script>
    <br>
...
<div id="listaOrdenes">   
    ...
    $sql_orden_compra = mysql_query("select * from orden_compra_servicio, tipos_documentos 
												...
												and tipos_documentos.modulo = 12 order by orden_compra_servicio.fecha_elaboracion ASC");
    $i = 0;
