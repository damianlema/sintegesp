...
function ingresarRequisitos(){
	...
	var ajax=nuevoAjax();
		ajax.open("POST", "modulos/recaudacion/lib/asociar_tipo_solicitud_concepto_ajax.php", true);	
		...
		ajax.onreadystatechange=function() { 
			...
			if (ajax.readyState==4){
				if(ajax.responseText == "existe"){
					mostrarMensajes("error", "Disculpe el Concepto Tributaroi que intenta asociar ya esta asociado para esta actividad comercial");
