...
if ($_GET["accion"] == 343 || $_GET["accion"] == 344){   // si entra para modificar o eliminar busca el registro para cargar los datos en el formulario
...
<body>
	<br>
	<h4 align=center>SNC Grupo Actividad</h4>
	<h2 class="sqlmVersion"></h2>
	<br>
<form id="frmsnc_grupo_actividad" action="principal.php?modulo=4&accion=<?=$_GET["accion"]?>" method="POST" enctype="multipart/form-data">	
...
<tr>
			  <td align='right' class='viewPropTitle'>Familia Actividad:</td>
			  <td class=''>
              <?php
...
&nbsp;<a href='principal.php?modulo=4&accion=341' class='Browse'><img src="imagenes/nuevo.png" border="0" title="Nuevo SNC Grupo Actividad"></a>
          ...
          <iframe name="pdf" id="pdf" style="display:none" height="500" width="500"></iframe>          
			...
			<tr>
				...
				<td class=''><input type="text" name="descripcion" maxlength="255" size="45" id="descripcion" <?php echo 'value="'.$regsnc_grupo_actividad['descripcion'].'"';?> onKeyUp="validarVacios('descripcion', this.value, 'frmsnc_grupo_actividad')" onBlur="validarVacios('descripcion', this.value, 'frmsnc_grupo_actividad')" autocomplete="OFF" style="padding:0px 20px 0px 0px;"></td>
			</tr>
            <tr>
...
<table align=center cellpadding=2 cellspacing=0>
			<tr><td>
			<?php
					if($_GET["accion"] != 343 and $_GET["accion"] != 344 and in_array(342, $privilegios) == true){
						echo "<input align=center class='button' name='ingresar' type='submit' value='Ingresar'>";
					}
				
					if($_GET["accion"] == 343 and in_array($_GET["accion"], $privilegios) == true){
						echo "<input align=center class='button' name='modificar' type='submit' value='Modificar'>";
					}
				
					if($_GET["accion"] == 344 and in_array($_GET["accion"], $privilegios) == true){
				...
				<tr>
					<td align="center">
					  <form name="grilla" action="" method="POST">
						<table class="Browse" align=center cellpadding="0" cellspacing="0" width="70%">
							<thead>
								<tr>
						  ...
						  <tr bgcolor='#e7dfce' onMouseOver="setRowColor(this, 0, 'over', '#e7dfce', '#EAFFEA', '#FFFFAA')" onMouseOut="setRowColor(this, 0, 'out', '#e7dfce', '#EAFFEA', '#FFFFAA')">
								...
								$bus = mysql_fetch_array($sql);
									...
									if(in_array(343,$privilegios)==true){
										echo "<td align='center' class='Browse' width='3%'><a href='principal.php?modulo=4&accion=343&c=$c&id_familia=".$bus["idsnc_familia_actividad"]."' class='Browse'><img src='imagenes/modificar.png' border='0' alt='Modificar' title='Modificar'></a></td>";
									}
									if(in_array(344,$privilegios) == true){
										echo "<td align='center' class='Browse' width='3%'><a href='principal.php?modulo=4&accion=344&c=$c' class='Browse'><img src='imagenes/delete.png' border='0' alt='Borrar' title='Borrar'></a></td>";	
									}
									echo "</tr>";
									}
							}?>
...
<script> document.frmsnc_grupo_actividad.descripcion.focus() </script>
</body>
</html>
...
if($_GET["accion"] == 342 and in_array(342, $privilegios)==true){	
	if (mysql_num_rows($busca_existe_registro)>0){
		mensaje("Disculpe el registro que intenta ingresar ya existe");
		redirecciona("principal.php?modulo=4&accion=341");  // envia mensaje de error que el registro ya existe
	}else{
			...
			redirecciona("principal.php?modulo=4&accion=341");
		}
	}
	if ($_GET["accion"] ==343 and in_array(343, $privilegios)==true and !$_POST["buscar"]){
	...
	if ($_GET["accion"] == 344 and in_array(344, $privilegios) == true and !$_POST["buscar"]){
