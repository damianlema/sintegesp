<script src="modulos/administracion/js/modificarFechaOrdenCompra_ajax.js"></script>
    <br>
<h4 align=center>Modificar Fechas de las Ordenes</h4>
...
<tr>
      ...
      <td width="144"><input type="text" name="campoBuscar" id="campoBuscar"></td>
        ...
        <td width="89">
            ...
            <?
            $sql_tipo_documento = mysql_query("select * from tipos_documentos where modulo like '%-4-%' and compromete= 'si'");
