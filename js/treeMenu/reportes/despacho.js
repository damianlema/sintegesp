...
stIT("p2i3",["Catálogo de Materiales","javascript:llamarFiltro('catalogo_materiales', 'compras_servicios')"],"p1i2");
stES();
stIT("p0i2",["           Certificación de Compromisos"],"p0i0");
stBS("p4",[],"p1");
stIT("p4i0",["Certificación de Compromisos","javascript:llamarFiltro('filtro_orden_compra_servicio', 'compras_servicios')"],"p1i0");
stES();
