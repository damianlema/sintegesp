...
function llamarFiltro(nombre, modulo) {
       var ajax=nuevoAjax();
        ajax.open("GET", "lib/reportes/"+modulo+"/filtros.php", true);
...
stBS("p4",[],"p1");
stIT("p4i0",["Solicitud de Cotizaciones","javascript:llamarFiltro('filtro_solicitud_cotizacion_com', 'compras_servicios')"],"p1i0");
stES();
stIT("p0i3",["           Requisición"],"p0i0");
stBS("p5",[],"p1");
stIT("p5i0",["Requisición de Compra/Servicio","javascript:llamarFiltro('filtro_requisicion', 'compras_servicios')"],"p1i0");
stES();
stIT("p0i4",["           Orden de Compra/Servicio"],"p0i0");
stBS("p6",[],"p1");
...
stIT("p6i2",["Ordenes por Financiamiento","javascript:llamarFiltro('ordenes_compra_por_financiamiento', 'compras_servicios')"],"p1i0");
stES();
stIT("p0i5",["           Sumarios"],"p0i0");
stBS("p7",[],"p1");
stIT("p7i0",["Sumario EXCEL","javascript:llamarFiltro('filtro_sumarios_snc', 'compras_servicios')"],"p1i0");
stIT("p7i0",["Sumario CSV","javascript:llamarFiltro('sumario_masivo', 'compras_servicios')"],"p1i0");
