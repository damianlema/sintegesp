...
function llamarFiltro(nombre) {
       var ajax=nuevoAjax();
        ajax.open("POST", "lib/gobernacion/generar_filtro.php", true);	
        ...
        ajax.onreadystatechange=function() { 
            ...
            if (ajax.readyState==4){
                ...
                frmReporte.location.href = "lib/gobernacion/generar_filtro.php?nombre="+nombre;
...
function llamarReporte(nombre) {
        var ajax=nuevoAjax();
        ajax.open("POST", "lib/gobernacion/recursos_humanos.php", true);	
		ajax.setRequestHeader("Content-Type","application/x-www-form-urlencoded");
        ajax.onreadystatechange=function() { 
            if(ajax.readyState == 1){
                document.getElementById("divCargando").style.display = "block";
            ...
            if (ajax.readyState==4){
                document.getElementById("aCerrar").style.display = "block";	
                document.getElementById("frmReporte").style.display = "block";			
                frmReporte.location.href = "lib/gobernacion/recursos_humanos.php?nombre="+nombre;
                document.getElementById("divCargando").style.display = "none";
            } 
        }
        ajax.send("nombre="+nombre);
...
stIT("p1i0",["Grupos de Cargos","javascript:llamarFiltro('grupos')",,,,"imagenes/treeMenu/pdf.png","imagenes/treeMenu/pdf.png",20,20,"8pt 'Arial'","#FFFFFF",,,"imagenes/treeMenu/XPline.gif","repeat-y","8pt 'Arial'","#000000",,,"imagenes/treeMenu/XPline.gif","repeat-y","8pt 'Arial'",,,,"imagenes/treeMenu/XPline.gif","repeat-y","8pt 'Arial'","#000000","underline",,"imagenes/treeMenu/XPline.gif","repeat-y",,,,,0,0,"","","","",0,0,0],"p0i0");
stIT("p1i1",["Series de Cargos","javascript:llamarFiltro('series')",,,,"imagenes/treeMenu/pdf.png","imagenes/treeMenu/pdf.png"],"p1i0");
stIT("p1i2",["Cargos","javascript:llamarFiltro('cargos')",,,,"imagenes/treeMenu/pdf.png","imagenes/treeMenu/pdf.png"],"p1i0");
stES();
stIT("p0i1",["           Estudios"],"p0i0");
stBS("p2",[,,,,,,,,3],"p1");
stIT("p2i0",["Nivel de Estudio","javascript:llamarReporte('nivel')"],"p1i0");
stIT("p2i1",["Profesiones","javascript:llamarFiltro('profesion')"],"p1i1");
stIT("p2i2",["Mensiones","javascript:llamarReporte('mensiones')"],"p1i2");
stES();
stIT("p0i2",["           Otras"],"p0i0");
stBS("p3",[],"p2");
stIT("p3i0",["Estado Civil","javascript:llamarReporte('edocivil')"],"p1i0");
stIT("p3i1",["Parentesco","javascript:llamarReporte('parentesco')"],"p1i1");
stIT("p3i2",["Grupo Sanguíneo","javascript:llamarReporte('gsang')"],"p1i2");
stIT("p3i3",["Tipos de Movimiento","javascript:llamarReporte('tmov')"],"p1i2");
stES();
stIT("p0i3",["           Trabajador"],"p0i0");
stBS("p4",[],"p2");
stIT("p4i0",["Lista de Trabajadores","javascript:llamarFiltro('listatrab')"],"p1i0");
stES();
stIT("p0i4",["           Certificación de Compromisos"],"p0i0");
stBS("p6",[],"p1");
stIT("p6i0",["Certificación de Compromisos","javascript:llamarFiltro('filtro_compromisos')"],"p1i0");
stES();
stIT("p0i5",["           Catálogo de Conceptos"],"p0i0");
stBS("p7",[],"p1");
stIT("p7i0",["Catálogo de Conceptos","javascript:llamarFiltro('catalogo_materiales')"],"p1i0");
stES();
