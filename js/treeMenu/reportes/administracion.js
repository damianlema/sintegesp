...
stIT("p1i6",["Documentos Entregados","javascript:llamarFiltro('dbeneficiario', 'recursos_humanos')"],"p1i2");
...
stES();
stES();
stIT("p0i2",["           Solicitud de Cotizaciones"],"p0i0");
stBS("p4",[],"p1");
stIT("p4i0",["Solicitud de Cotizaciones","javascript:llamarFiltro('filtro_solicitud_cotizacion', 'administracion')"],"p1i0");
stES();
stIT("p0i3",["           Orden de Compra/Servicio"],"p0i0");
stBS("p5",[],"p1");
stIT("p5i0",["Orden de Compra/Servicio","javascript:llamarFiltro('filtro_orden_compra_servicio', 'compras_servicios')"],"p1i0");
stIT("p5i1",["Ordenes por Financiamiento","javascript:llamarFiltro('ordenes_compra_por_financiamiento', 'compras_servicios')"],"p1i0");
stES();
...
stIT("p6i1",["Totales Por Proveedor","javascript:llamarReporte('totales_por_proveedor', 'compras_servicios')"],"p1i0");
stES();
stIT("p0i5",["           Orden de Pago"],"p0i0");
stBS("p7",[],"p1");
stIT("p7i0",["Orden de Pago","javascript:llamarFiltro('filtro_orden_pago', 'administracion')"],"p1i0");
stIT("p7i1",["Ordenes por Financiamiento","javascript:llamarFiltro('ordenes_pago_por_financiamiento', 'administracion')"],"p1i0");
stIT("p7i2",["Ordenes por Dependencia","javascript:llamarFiltro('filtro_orden_pagod', 'administracion')"],"p1i0");
stES();
